...
#define PARIVERSION "GP/PARI CALCULATOR Version 2.17.3 (released)"
#define PARIINFO "amd64 running linux (x86-64/GMP-%s kernel) 64-bit version"
#define PARI_VERSION_CODE 135427
...
#define GCC_VERSION "gcc version 13.3.0 (Ubuntu 13.3.0-6ubuntu2~24.04)"
#define ASMINLINE
