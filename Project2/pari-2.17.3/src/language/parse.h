...
# define PARI_TOKENTYPE
  ...
  {
    PARI_EMPTY = -2,
    PARI_EOF = 0,                  /* "end of file"  */
    PARI_error = 256,              /* error  */
    PARI_UNDEF = 257,              /* "invalid token"  */
    KPARROW = 258,                 /* ")->"  */
    KARROW = 259,                  /* "->"  */
    KDOTDOT = 260,                 /* ".."  */
    KPE = 261,                     /* "+="  */
    ...
    KPP = 280,                     /* "++"  */
    KSS = 281,                     /* "--"  */
    KINTEGER = 282,                /* "integer"  */
    KREAL = 283,                   /* "real number"  */
    KENTRY = 284,                  /* "variable name"  */
    KSTRING = 285,                 /* "character string"  */
    SEQ = 286,                     /* SEQ  */
    DEFFUNC = 287,                 /* DEFFUNC  */
    INT = 288,                     /* INT  */
    LVAL = 289,                    /* LVAL  */
  ...
  typedef enum pari_tokentype pari_token_kind_t;
#endif
