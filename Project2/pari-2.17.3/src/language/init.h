...
{"!_",0,(void*)gnot,19,"G","!a: boolean operator \"not\"."},
{"#_",0,(void*)glength,19,"lG","#x: number of non code words in x, number of characters for a string."},
{"#_~",0,(void*)gtranslength,19,"lG","#x~: number of non code words in x~"},
{"%",0,(void*)pari_get_hist,19,"D0,L,","last history item."},
{"%#",0,(void*)pari_histtime,19,"D0,L,","time to compute last history item."},
{"+_",0,NULL,19,NULL,"+_: copy and return its argument"},
{"-_",0,(void*)gneg,19,"G","-_: negate argument"},
...
{"Mod",0,(void*)gmodulo,3,"GG","Mod(a,b): create 'a modulo b'."},
{"O",0,(void*)ggrando,6,"","O(p^e): p-adic or power series zero with precision given by e."},
{"O(_^_)",0,(void*)ggrando,21,"GD1,L,","O(p^e): p-adic or power series zero with precision given by e."},
...
{"Qfb",0,(void*)Qfb0,3,"GDGDG","Qfb(a,{b},{c}): binary quadratic form a*x^2+b*x*y+c*y^2."},
...
{"Strchr",0,(void*)pari_strchr,1,"G","Strchr(x): deprecated alias for strchr."},
{"Strexpand",0,(void*)strexpand,1,"s*","Strexpand({x}*): deprecated alias for strexpand"},
{"Strprintf",0,(void*)strprintf,1,"ss*","Strprintf(fmt,{x}*): deprecated alias for strprintf."},
{"Strtex",0,(void*)strtex,1,"s*","Strtex({x}*): deprecated alias for strtex."},
...
{"[_.._]",0,(void*)vecrange,21,"GG","[a..b] = [a,a+1,...,b]"},
{"[_|_<-_,_;_]",0,(void*)vecexpr1,21,"mGVDEDE","[a(x)|x<-b,c(x);...]"},
{"[_|_<-_,_]",0,(void*)vecexpr0,21,"GVDEDE","[a(x)|x<-b,c(x)] = apply(a,select(c,b))"},
{"_!",0,(void*)mpfact,19,"L","n!: factorial of n."},
{"_!=_",0,(void*)gne,19,"GG","a!=b: true if a and b are not equal."},
{"_#",0,(void*)mpprimorial,19,"L","n#: primorial of n."},
{"_%=_",0,(void*)gmode,19,"&G","x%=y: shortcut for x=x%y."},
{"_%_",0,(void*)gmod,19,"GG","x%y: Euclidean remainder of x and y."},
{"_&&_",0,(void*)andpari,19,"GE","a&&b: boolean operator \"and\"."},
{"_'",0,(void*)deriv,19,"GDn","x': derivative of x with respect to the main variable."},
{"_'_",0,(void*)derivn,19,"GLDn","x': derivative of x with respect to the main variable."},
{"_(_)",0,NULL,19,NULL,"f(a,b,...): evaluate the function f on a,b,..."},
{"_*=_",0,(void*)gmule,19,"&G","x*=y: shortcut for x=x*y."},
{"_*_",0,(void*)gmul,19,"GG","x*y: product of x and y."},
{"_++",0,(void*)gadd1e,19,"&","x++: set x to x+1."},
{"_+=_",0,(void*)gadde,19,"&G","x+=y: shortcut for x=x+y."},
{"_+_",0,(void*)gadd,19,"GG","x+y: sum of x and y."},
{"_--",0,(void*)gsub1e,19,"&","x--: set x to x-1."},
{"_-=_",0,(void*)gsube,19,"&G","x-=y: shortcut for x=x-y."},
{"_-_",0,(void*)gsub,19,"GG","x-y: difference of x and y."},
{"_.a1",0,(void*)member_a1,20,"mG","_.a1"},
{"_.a2",0,(void*)member_a2,20,"mG","_.a2"},
{"_.a3",0,(void*)member_a3,20,"mG","_.a3"},
{"_.a4",0,(void*)member_a4,20,"mG","_.a4"},
{"_.a6",0,(void*)member_a6,20,"mG","_.a6"},
{"_.area",0,(void*)member_area,20,"mG","_.area"},
{"_.b2",0,(void*)member_b2,20,"mG","_.b2"},
{"_.b4",0,(void*)member_b4,20,"mG","_.b4"},
{"_.b6",0,(void*)member_b6,20,"mG","_.b6"},
{"_.b8",0,(void*)member_b8,20,"mG","_.b8"},
{"_.bid",0,(void*)member_bid,20,"mG","_.bid"},
{"_.bnf",0,(void*)member_bnf,20,"mG","_.bnf"},
{"_.c4",0,(void*)member_c4,20,"mG","_.c4"},
{"_.c6",0,(void*)member_c6,20,"mG","_.c6"},
{"_.clgp",0,(void*)member_clgp,20,"mG","_.clgp"},
{"_.codiff",0,(void*)member_codiff,20,"mG","_.codiff"},
{"_.cyc",0,(void*)member_cyc,20,"mG","_.cyc"},
{"_.diff",0,(void*)member_diff,20,"mG","_.diff"},
{"_.disc",0,(void*)member_disc,20,"mG","_.disc"},
{"_.e",0,(void*)member_e,20,"mG","_.e"},
{"_.eta",0,(void*)member_eta,20,"mG","_.eta"},
{"_.f",0,(void*)member_f,20,"mG","_.f"},
{"_.fu",0,(void*)member_fu,20,"G","_.fu"},
{"_.gen",0,(void*)member_gen,20,"mG","_.gen"},
{"_.group",0,(void*)member_group,20,"mG","_.group"},
{"_.index",0,(void*)member_index,20,"mG","_.index"},
{"_.j",0,(void*)member_j,20,"mG","_.j"},
{"_.mod",0,(void*)member_mod,20,"mG","_.mod"},
{"_.nf",0,(void*)member_nf,20,"mG","_.nf"},
{"_.no",0,(void*)member_no,20,"mG","_.no"},
{"_.normfu",0,(void*)member_normfu,20,"mG","_.normfu"},
{"_.omega",0,(void*)member_omega,20,"mG","_.omega"},
{"_.orders",0,(void*)member_orders,20,"mG","_.orders"},
{"_.p",0,(void*)member_p,20,"mG","_.p"},
{"_.pol",0,(void*)member_pol,20,"mG","_.pol"},
{"_.polabs",0,(void*)member_polabs,20,"mG","_.polabs"},
{"_.r1",0,(void*)member_r1,20,"mG","_.r1"},
{"_.r2",0,(void*)member_r2,20,"mG","_.r2"},
{"_.reg",0,(void*)member_reg,20,"mG","_.reg"},
{"_.roots",0,(void*)member_roots,20,"mG","_.roots"},
{"_.sign",0,(void*)member_sign,20,"mG","_.sign"},
{"_.t2",0,(void*)member_t2,20,"G","_.t2"},
{"_.tate",0,(void*)member_tate,20,"mG","_.tate"},
{"_.tu",0,(void*)member_tu,20,"G","_.tu"},
{"_.zk",0,(void*)member_zk,20,"mG","_.zk"},
{"_.zkst",0,(void*)member_zkst,20,"mG","_.zkst"},
{"_/=_",0,(void*)gdive,19,"&G","x/=y: shortcut for x=x/y."},
{"_/_",0,(void*)gdiv,19,"GG","x/y: quotient of x and y."},
{"_<<=_",0,(void*)gshiftle,19,"&L","x<<=y: shortcut for x=x<<y."},
{"_<<_",0,(void*)gshift,19,"GL","x<<y: compute shift(x,y)."},
{"_<=_",0,(void*)gle,19,"GG","x<=y: return 1 if x is less or equal to y, 0 otherwise."},
{"_<_",0,(void*)glt,19,"GG","x<y: return 1 if x is strictly less than y, 0 otherwise."},
{"_===_",0,(void*)gidentical,19,"iGG","x===y: return 1 if x and y are identical, 0 otherwise."},
{"_==_",0,(void*)geq,19,"GG","x==y: return 1 if x and y are equal, 0 otherwise."},
{"_>=_",0,(void*)gge,19,"GG","x>=y: return 1 if x is greater or equal to y, 0 otherwise."},
{"_>>=_",0,(void*)gshiftre,19,"&L","x>>=y: shortcut for x=x>>y."},
{"_>>_",0,(void*)gshift_right,19,"GL","x>>y: compute shift(x,-y)."},
{"_>_",0,(void*)ggt,19,"GG","x>y: return 1 if x is strictly greater than y, 0 otherwise."},
{"_F2xq_log_Coppersmith_worker",0,(void*)F2xq_log_Coppersmith_worker,21,"GLGG","F2xq_log_Coppersmith_worker: worker for F2xq_log_Coppersmith"},
{"_Flxq_log_Coppersmith_worker",0,(void*)Flxq_log_Coppersmith_worker,21,"GLGG","Flxq_log_Coppersmith_worker: worker for Flxq_log_Coppersmith"},
{"_FpM_ratlift_worker",0,(void*)FpM_ratlift_worker,21,"GGG","worker for FpM_ratlift"},
{"_Fp_log_sieve_worker",0,(void*)Fp_log_sieve_worker,21,"LLGGGGGG","Fp_log_sieve_worker: worker for Fp_log_sieve"},
{"_QM_charpoly_ZX_worker",0,(void*)QM_charpoly_ZX_worker,21,"GGG","worker for QM_charpoly_ZX"},
{"_QXQ_div_worker",0,(void*)QXQ_div_worker,21,"GGGG","worker for QXQ_div"},
{"_QXQ_inv_worker",0,(void*)QXQ_inv_worker,21,"GGG","worker for QXQ_inv"},
{"_RgM_ZM_mul_worker",0,(void*)RgM_ZM_mul_worker,21,"GG","worker for RgM_ZM_mul"},
{"_ZM_det_worker",0,(void*)ZM_det_worker,21,"GG","worker for ZM_det"},
{"_ZM_gauss_worker",0,(void*)ZM_gauss_worker,21,"GGG","worker for ZM_gauss"},
{"_ZM_inv_worker",0,(void*)ZM_inv_worker,21,"GG","worker for ZM_inv"},
{"_ZM_ker_worker",0,(void*)ZM_ker_worker,21,"GG","worker for ZM_ker"},
{"_ZM_mul_worker",0,(void*)ZM_mul_worker,21,"GGG","worker for ZM_mul"},
{"_ZM_sqr_worker",0,(void*)ZM_sqr_worker,21,"GG","worker for ZM_sqr"},
{"_ZXQX_composedsum_worker",0,(void*)ZXQX_composedsum_worker,21,"GGGG","worker for ZXQX_composedsum"},
{"_ZXQX_resultant_worker",0,(void*)ZXQX_resultant_worker,21,"GGGGG","worker for ZXQX_resultant"},
{"_ZXQ_minpoly_worker",0,(void*)ZXQ_minpoly_worker,21,"GGGL","worker for ZXQ_minpoly"},
{"_ZX_ZXY_resultant_worker",0,(void*)ZX_ZXY_resultant_worker,21,"GGGGG","worker for ZX_ZXY_resultant"},
{"_ZX_composedsum_worker",0,(void*)ZX_composedsum_worker,21,"GGG","worker for ZX_composedsum"},
{"_ZX_gcd_worker",0,(void*)ZX_gcd_worker,21,"GGGG","worker for ZX_gcd"},
{"_ZX_resultant_worker",0,(void*)ZX_resultant_worker,21,"GGGG","worker for ZX_resultant"},
{"_ZabM_inv_worker",0,(void*)ZabM_inv_worker,21,"GGG","worker for ZabM_inv"},
{"_[_,]",0,NULL,19,NULL,"x[y,]: y-th row of x."},
{"_[_,_]",0,NULL,19,NULL,"x[i{,j}]: i coefficient of a vector, i,j coefficient of a matrix"},
{"_[_.._,_.._]",0,(void*)matslice0,19,"GD0,L,D0,L,D0,L,D0,L,","x[a..b,c..d] = [x[a,c],  x[a+1,c],  ...,x[b,c];                      x[a,c+1],x[a+1,c+1],...,x[b,c+1];                        ...       ...          ...                      x[a,d],  x[a+1,d]  ,...,x[b,d]]"},
{"_[_.._]",0,(void*)vecslice0,19,"GD0,L,L","x[a..b] = [x[a],x[a+1],...,x[b]]"},
{"_\\/=_",0,(void*)gdivrounde,19,"&G","x\\/=y: shortcut for x=x\\/y."},
{"_\\/_",0,(void*)gdivround,19,"GG","x\\/y: rounded Euclidean quotient of x and y."},
{"_\\=_",0,(void*)gdivente,19,"&G","x\\=y: shortcut for x=x\\y."},
{"_\\_",0,(void*)gdivent,19,"GG","x\\y: Euclidean quotient of x and y."},
{"_^_",0,(void*)gpow,19,"GGp","x^y: compute x to the power y."},
{"_^s",0,(void*)gpowgs,21,"GL","return x^n where n is a small integer"},
{"__",0,NULL,19,NULL,"__: integral concatenation of strings."},
{"_aprcl_step4_worker",0,(void*)aprcl_step4_worker,21,"UGGG","worker for isprime (APRCL step 4)"},
{"_aprcl_step6_worker",0,(void*)aprcl_step6_worker,21,"GLGGG","worker for isprime (APRCL step 6)"},
{"_chinese_unit_worker",0,(void*)chinese_unit_worker,21,"GGGGGG","worker for _.fu"},
{"_derivfun",0,(void*)derivfun0,21,"GGGD1,L,p","_derivfun(args,def,closure,k) numerical kth-derivation of closure with respect to the first variable at args"},
{"_dirartin_worker",0,(void*)dirartin_worker,21,"GUGGGG","lfunartin worker"},
{"_direllnf_worker",0,(void*)direllnf_worker,21,"GUG","ellan worker"},
{"_direllsympow_worker",0,(void*)direllsympow_worker,21,"GUGU","lfunsympow worker"},
{"_dirgenus2_worker",0,(void*)dirgenus2_worker,21,"GLG","lfungenus2 worker"},
{"_dirhgm_worker",0,(void*)dirhgm_worker,21,"GUGG","worker for hgmcoefs"},
{"_ecpp_ispsp_worker",0,(void*)ecpp_ispsp_worker,21,"G","worker for isprime (ECPP ispseudoprime step)"},
{"_ecpp_sqrt_worker",0,(void*)ecpp_sqrt_worker,21,"GGG","worker for isprime (ECPP sqrt step)"},
{"_ecpp_step2_worker",0,(void*)ecpp_step2_worker,21,"GGGL","worker for isprime (step 2)"},
{"_eisker_worker",0,(void*)eisker_worker,21,"GGGGG","worker for eisker"},
{"_ellQ_factorback_worker",0,(void*)ellQ_factorback_worker,21,"GGGGU","worker for ellQ_factorback"},
{"_eval_mnemonic",0,(void*)eval_mnemonic,21,"lGs","Convert a mnemonic string to a flag."},
{"_factor_Aurifeuille",0,(void*)factor_Aurifeuille,21,"GL","_factor_Aurifeuille(a,d): return an algebraic factor of Phi_d(a), a != 0"},
{"_factor_Aurifeuille_prime",0,(void*)factor_Aurifeuille_prime,21,"GL","_factor_Aurifeuille_prime(p,d): return an algebraic factor of Phi_d(p), p prime"},
{"_inv",0,(void*)ginv,21,"G","return x^-1 where n is a small integer"},
{"_lerch_worker",0,(void*)lerch_worker,21,"GG","_lerch_worker(E,t): worker for lerchzeta"},
{"_lfuninit_theta2_worker",0,(void*)lfuninit_theta2_worker,21,"LGGGGGG","worker for lfuninit using theta2"},
{"_lfuninit_worker",0,(void*)lfuninit_worker,21,"LGGGGGGGG","worker for lfuninit"},
{"_multi_if",0,(void*)ifpari_multi,21,"GE*","internal variant of if() that allows more than 3 arguments."},
{"_nflist_A462_worker",0,(void*)nflist_A462_worker,21,"GGGGG","nflist_A462_worker(P3,X,Xinf,listarch,GAL): auxiliary."},
{"_nflist_A46S46P_worker",0,(void*)nflist_A46S46P_worker,21,"GGGG","nflist_A46S46P_worker(P3,Xinf,sqX,cards): auxiliary."},
{"_nflist_A4S4_worker",0,(void*)nflist_A4S4_worker,21,"GGGG","nflist_A4S4_worker(P3,X,Xinf,cardsprec): auxiliary."},
{"_nflist_C32C4_worker",0,(void*)nflist_C32C4_worker,21,"GGGG","nflist_C32C4_worker(P4,X,Xinf,GAL): auxiliary."},
{"_nflist_C32D4_worker",0,(void*)nflist_C32D4_worker,21,"GGGG","nflist_C32D4_worker(P,X,Xinf,gs): auxiliary."},
{"_nflist_C3C3_worker",0,(void*)nflist_C3C3_worker,21,"GGGG","nflist_C3C3_worker(gi,V3,V3D,X): auxiliary."},
{"_nflist_C3_worker",0,(void*)nflist_C3_worker,21,"GG","nflist_C3_worker(gv,T): auxiliary."},
{"_nflist_C4vec_worker",0,(void*)nflist_C4vec_worker,21,"GGGG","nflist_C4vec_worker(gm,X,Xinf,X2,gs): auxiliary."},
{"_nflist_C5_worker",0,(void*)nflist_C5_worker,21,"GG","nflist_C5_worker(N,bnfC5): auxiliary."},
{"_nflist_C6_worker",0,(void*)nflist_C6_worker,21,"GGGGG","nflist_C6_worker(P3,X,Xinf,M,T): auxiliary."},
{"_nflist_C9_worker",0,(void*)nflist_C9_worker,21,"GGG","nflist_C9_worker(P,X,Xinf): auxiliary."},
{"_nflist_CL_worker",0,(void*)nflist_CL_worker,21,"GGG","nflist_CL_worker(Fcond,bnf,ellprec): auxiliary."},
{"_nflist_D4_worker",0,(void*)nflist_D4_worker,21,"GGGG","nflist_D4_worker(D,X,Xinf,listarch): auxiliary."},
{"_nflist_D612_worker",0,(void*)nflist_D612_worker,21,"GGGG","nflist_D612_worker(P3,X,Xinf,X2,limd2s2): auxiliary."},
{"_nflist_D9_worker",0,(void*)nflist_D9_worker,21,"GGG","nflist_D9_worker(P2,X,Xinf): auxiliary."},
{"_nflist_DL_worker",0,(void*)nflist_DL_worker,21,"GGGGGG","nflist_DL_worker(P2,X1p,X0p,X,Xinf,ells): auxiliary."},
{"_nflist_Mgen_worker",0,(void*)nflist_Mgen_worker,21,"GGGG","nflist_Mgen_worker(field,X,Xinf,ella): auxiliary."},
{"_nflist_S32_worker",0,(void*)nflist_S32_worker,21,"GGGGG","nflist_S32_worker(all1,X,Xinf,V3,sprec): auxiliary."},
{"_nflist_S36_worker",0,(void*)nflist_S36_worker,21,"GGG","nflist_S36_worker(pol,X,Xinf,X2): auxiliary."},
{"_nflist_S3C3_worker",0,(void*)nflist_S3C3_worker,21,"GGG","nflist_S3C3_worker(D2,X,Xinf,X2): auxiliary."},
{"_nflist_S3I_worker",0,(void*)nflist_S3I_worker,21,"GG","nflist_S3I_worker(ga,ALLCTS): auxiliary."},
{"_nflist_S3R_worker",0,(void*)nflist_S3R_worker,21,"GG","nflist_S3R_worker(ga,ALLCTS): auxiliary."},
{"_nflist_S462_worker",0,(void*)nflist_S462_worker,21,"GGGGG","nflist_S462_worker(P3,X,Xinf,listarch,GAL): auxiliary."},
{"_nflist_S46M_worker",0,(void*)nflist_S46M_worker,21,"GGGG","nflist_S46M_worker(P3,X,Xinf,sprec): auxiliary."},
{"_nflist_V4_worker",0,(void*)nflist_V4_worker,21,"GGGG","nflist_V4_worker(D1,X,Xinf,gs): auxiliary."},
{"_nxMV_polint_worker",0,(void*)nxMV_polint_center_tree_worker,21,"GGGGG","used for parallel chinese"},
{"_parapply_slice_worker",0,(void*)parapply_slice_worker,21,"GG","_parapply_slice_worker(v,C): return [C(x) | x<-v]."},
{"_pareval_worker",0,(void*)pareval_worker,21,"G","_pareval_worker(C): evaluate the closure C."},
{"_parfor_worker",0,(void*)parfor_worker,21,"GG","_parfor_worker(i,C): evaluate the closure C on i and return [i,C(i)]"},
{"_parsqf_worker",0,(void*)parsqf_worker,21,"GGG","_parsqf_worker(gk,vR,data): auxiliary."},
{"_parsum_slice_worker",0,(void*)parsum_slice_worker,21,"GGGG","_parsum_slice_worker(a,b,m,C): return sum(k=0,(b-a)\\m,C(a+k*m)). a and m must be integers and m must be positive."},
{"_parsumprimefun_worker",0,(void*)parsumprimefun_worker,21,"GGGGGG","_parsumprimefun_worker(gk,s,zerf,data,vW,f): auxiliary"},
{"_partmap_reverse_frac_worker",0,(void*)partmap_reverse_frac_worker,21,"GGGGGL","worker for partmap_reverse_frac"},
{"_parvector_worker",0,(void*)parvector_worker,21,"GG","_parvector_worker(i,C): evaluate the closure C on i."},
{"_polclass_worker",0,(void*)polclass_worker,21,"GGG","used by polclass"},
{"_polint_worker",0,(void*)nmV_polint_center_tree_worker,21,"GGGGG","used for parallel chinese"},
{"_polmodular_worker",0,(void*)polmodular_worker,21,"GUGGGGLGGGG","used by polmodular"},
{"_primecertisvalid_ecpp_worker",0,(void*)primecertisvalid_ecpp_worker,21,"G","worker for primecertisvalid"},
{"_ramanujantau_worker",0,(void*)ramanujantau_worker,21,"GGGG","worker for ramanujantau"},
{"_safecoeff",0,NULL,19,NULL,"safe version of x[a], x[,a] and x[a,b]. Must be lvalues."},
{"_serh_worker",0,(void*)serh_worker,21,"GGGGG","_serh_worker(gk,V,a,ns,gprec): auxiliary."},
{"_taugen_n_worker",0,(void*)taugen_n_worker,21,"GGG","worker for ramanujantau"},
{"_void_if",0,(void*)ifpari_void,21,"vGDIDI","internal variant of if() that does not return a value."},
{"_||_",0,(void*)orpari,19,"GE","a||b: boolean operator \"or\" (inclusive)."},
{"_~",0,(void*)gtrans,19,"G","x~: transpose of x."},
...
{"airy",0,(void*)airy,8,"Gp","airy(z): Airy [Ai,Bi] function of argument z."},
{"alarm",0,(void*)gp_alarm,1,"D0,L,DE","alarm({s = 0},{code}): if code is omitted, trigger an \"e_ALARM\" exception after s seconds (wall-clock time), cancelling any previously set alarm; stop a pending alarm if s = 0 or is omitted. Otherwise, evaluate code, aborting after s seconds."},
{"algadd",0,(void*)algadd,11,"DGGG","algadd({al},x,y): element x+y in al (Hamilton quaternions if omitted)."},
...
{"algcharpoly",0,(void*)algcharpoly,11,"DGGDnD0,L,","algcharpoly({al},b,{v='x},{abs=0}): (reduced) characteristic polynomial of b in al (Hamilton quaternions if omitted), with respect to the variable v."},
{"algdegree",0,(void*)algdegree,11,"lG","algdegree(al): degree of the central simple algebra al."},
{"algdep",0,(void*)algdep0,7,"GLD0,L,","algdep(z,k,{flag=0}): algebraic relations up to degree k of z, using lindep([1,z,...,z^(k-1)], flag)."},
...
{"algdivl",0,(void*)algdivl,11,"DGGG","algdivl({al},x,y): element x\\y in al (Hamilton quaternions if omitted)."},
...
{"alghasse",0,(void*)alghasse,11,"GDG","alghasse(al,{pl}): the hasse invariant of the central simple algebra al at the place pl."},
...
{"alginit",0,(void*)alginit,11,"GGDnD3,L,","alginit(B,C,{v},{flag=3}): initializes the central simple algebra defined by data B, C. Binary digits of the flag mean 1: compute a maximal order; 2: fully factor the discriminant instead of using a lazy factorisation."},
{"alginv",0,(void*)alginv,11,"DGG","alginv({al},x): element 1/x in al (Hamilton quaternions if omitted)."},
...
{"algisdivl",0,(void*)algisdivl,11,"iDGGGD&","algisdivl({al},x,y,{&z}): tests whether y is left divisible by x and sets z to the left quotient x\\y."},
{"algisinv",0,(void*)algisinv,11,"iDGGD&","algisinv({al},x,{&ix}): tests whether x is invertible in al (Hamilton quaternions if omitted) and sets ix to the inverse of x."},
...
{"algneg",0,(void*)algneg,11,"DGG","algneg({al},x): element -x in al (Hamilton quaternions if omitted)."},
{"algnorm",0,(void*)algnorm,11,"DGGD0,L,","algnorm({al},x,{abs=0}): (reduced) norm of x."},
{"algpoleval",0,(void*)algpoleval,11,"DGGG","algpoleval({al},T,b): T in K[X] evaluate T(b) in al (Hamilton quaternions if omitted)."},
...
{"algrandom",0,(void*)algrandom,11,"DGG","algrandom({al},b): random element in al (Hamilton quaternions if omitted) with coefficients in [-b,b]."},
...
{"algsqr",0,(void*)algsqr,11,"DGG","algsqr({al},x): element x^2 in al (Hamilton quaternions if omitted)."},
...
{"algtensor",0,(void*)algtensor,11,"GGD3,L,","algtensor(al1,al2,{flag=3}): tensor product of al1 and al2."},
{"algtomatrix",0,(void*)algtomatrix,11,"DGGD0,L,","algtomatrix({al},x,{abs=0}): left multiplication table of x (table algebra or abs=1) or image of x under a splitting of al (CSA and abs=0)."},
{"algtrace",0,(void*)algtrace,11,"DGGD0,L,","algtrace({al},x,{abs=0}): (reduced) trace of x."},
...
{"arity",0,(void*)arity0,1,"G","arity(C): return the arity of the closure C."},
{"asin",0,(void*)gasin,8,"Gp","asin(x): arc sine of x."},
{"asinh",0,(void*)gasinh,8,"Gp","asinh(x): inverse hyperbolic sine of x."},
{"asympnum",0,(void*)asympnum0,9,"GDGp","asympnum(expr,{alpha = 1}): asymptotic expansion of expr assuming it has rational coefficients with reasonable height; alpha is as in limitnum."},
{"asympnumraw",0,(void*)asympnumraw0,9,"GLDGp","asympnumraw(expr,N,{alpha = 1}): N+1 first terms of asymptotic expansion of expr as floating point numbers; alpha is as in limitnum."},
{"atan",0,(void*)gatan,8,"Gp","atan(x): arc tangent of x."},
{"atanh",0,(void*)gatanh,8,"Gp","atanh(x): inverse hyperbolic tangent of x."},
{"bernfrac",0,(void*)bernfrac,4,"L","bernfrac(n): Bernoulli number B_n, as a rational number."},
{"bernpol",0,(void*)bernpol_eval,4,"LDG","bernpol(n,{a='x}): Bernoulli polynomial B_n, evaluated at a"},
{"bernreal",0,(void*)bernreal,4,"Lp","bernreal(n): Bernoulli number B_n, as a real number with the current precision."},
{"bernvec",0,(void*)bernvec,4,"L","bernvec(n): returns a vector containing, as rational numbers, the Bernoulli numbers B_0, B_2, ..., B_{2n}."},
...
{"besseljh",0,(void*)jbesselh,8,"GGp","besseljh(n,x): J-bessel function of index n+1/2 and argument x, where n is a nonnegative integer."},
{"besseljzero",0,(void*)besseljzero,8,"GD1,L,b","besseljzero(nu,{k=1}): k-th zero of the J-bessel function of index nu. Works for real and complex ordrers but the result is guaranteed only if nu is nonnegative."},
{"besselk",0,(void*)kbessel,8,"GGp","besselk(nu,x): K-bessel function of index nu and argument x."},
{"besseln",0,(void*)ybessel,8,"GGp","besseln(nu,x): deprecated alias for bessely."},
{"bessely",0,(void*)ybessel,8,"GGp","bessely(nu,x): Y-bessel function of index nu and argument x."},
{"besselyzero",0,(void*)besselyzero,8,"GD1,L,b","besselyzero(nu,{k=1}): k-th zero of the Y-bessel function of index nu. Works for real and complex ordrers but the result is guaranteed only if nu is nonnegative."},
{"bestappr",0,(void*)bestappr,5,"GDG","bestappr(x,{B}): return a rational approximation to x, whose denominator is limited by B, if present. This function applies to reals, intmods, p-adics, and rationals of course. Otherwise it applies recursively to all components."},
{"bestapprPade",0,(void*)bestapprPade0,5,"GD-1,L,D-1,L,","bestapprPade(x,{B},{Q}): returns a rational function approximation to x. This function applies to series, polmods, and rational functions of course. Otherwise it applies recursively to all components."},
...
{"binomial",0,(void*)binomial0,4,"GDG","binomial(n,{k}): binomial coefficient n*(n-1)...*(n-k+1)/k! defined for k in Z and any n. If k is omitted and n a nonnegative integer, return the vector [binomial(n,0),...,binomial(n,n)]."},
...
{"bitprecision",0,(void*)bitprecision00,3,"GDG","bitprecision(x,{n}): if n is present and positive, return x at precision n bits. If n is omitted, return real precision of object x in bits."},
...
{"bnfisintnorm",0,(void*)bnfisintnorm0,10,"GGD0,L,","bnfisintnorm(bnf,x,{flag=0}): compute a complete system of solutions (modulo units of positive norm) of the absolute norm equation N(a)=x, where a belongs to the maximal order of big number field bnf (if bnf is not certified, this depends on GRH). If (optional) flag is set, allow returning solutions in factored form."},
...
{"bnfissunit",0,(void*)bnfissunit,10,"GGG","bnfissunit(bnf,sfu,x): this function is obsolete, use bnfisunit."},
{"bnfisunit",0,(void*)bnfisunit0,10,"GGDG","bnfisunit(bnf,x,{U}): bnf being output by bnfinit, give the column vector of exponents of x on the fundamental units and the roots of unity if x is a unit, the empty vector otherwise. If U is present, as given by bnfunits, decompose x on the attached S-units generators."},
...
{"bnrcompositum",0,(void*)bnrcompositum,10,"GG","bnrcompositum(A,B): compositum [bnr,H] of the two abelian extensions given by A = [bnr1,H1] and B = [bnr2,H2], where bnr1 and bnr2 are attached to the same base field."},
...
{"bnrmap",0,(void*)bnrmap,10,"GG","bnrmap(A,B): if A and B are bnr structures for the same bnf attached to moduli mA and mB with mB | mA, return the canonical surjection from A to B. Alternatively, if A is a map from bnrmap and B is a congruence subgroup or ray class character modulo mA, return the corresponding object on Cl(mB)."},
...
{"bnrstarkunit",0,(void*)bnrstarkunit,10,"GDG","bnrstarkunit(bnr,{subgroup}): bnr being as output by bnrinit, returns the characteristic polynomial of the (conjectural) Stark unit corresponding to the module in bnr and the given congruence subgroup (the trivial subgroup if omitted). The ground field must be totally real and all but one infinite place must become complex in the class field."},
...
{"core",0,(void*)core0,5,"GD0,L,","core(n,{flag=0}): unique squarefree integer d dividing n such that n/d is a square. If (optional) flag is nonzero, output the two-component row vector [d,f], where d is the unique squarefree integer dividing n such that n/d=f^2 is a square."},
{"coredisc",0,(void*)coredisc0,5,"GD0,L,","coredisc(n,{flag=0}): discriminant of the quadratic field Q(sqrt(n)). If (optional) flag is nonzero, output a two-component row vector [d,f], where d is the discriminant of the quadratic field Q(sqrt(n)) and n=df^2. f may be a half integer."},
...
{"derivn",0,(void*)derivn,6,"GLDn","derivn(x,n,{v}): n-th derivative of x with respect to v, or to the main variable of x if v is omitted."},
{"derivnum",0,(void*)derivnum0,9,"V=GEDGp","derivnum(X=a,expr,{ind=1}): numerical derivation of expr with respect to X at X = a. The order of derivation is given by parameter 'ind', which can be a vector."},
...
{"digits",0,(void*)digits,3,"GDG","digits(x,{b}): gives the vector formed by the digits of x in base b."},
...
{"dirpowers",0,(void*)dirpowers,7,"LGp","dirpowers(n,x): return the vector [1^x,2^x,...,n^x]."},
{"dirpowerssum",0,(void*)dirpowerssum0,5,"GGDGD0,L,p","dirpowerssum(N,x,{f},{both=0}): return f(1)1^x + f(2)2^x + ... + f(N)N^x, where f is a completely multiplicative function (= 1 if omitted). If both is set, return the pair for arguments (x, f) and (-1-x, conj(f)). If both=2, assume in addition that f is real-valued."},
...
{"ell2cover",0,(void*)ell2cover,12,"Gp","ell2cover(E): if E is an elliptic curve over Q, returns a basis of the set of everywhere locally soluble 2-covers of the curve E. For each cover a pair [R,P] is returned where y^2-R(x) is a quartic curve and P belongs to E(k), where k = Q(x)[y] / (y^2-R(x))."},
{"ellE",0,(void*)ellE,8,"Gp","ellE(k): Complete elliptic integral of the second kind for the complex parameter k using the agm."},
{"ellK",0,(void*)ellK,8,"Gp","ellK(k): Complete elliptic integral of the first kind for the complex parameter k using the agm."},
{"ellL1",0,(void*)ellL1,12,"GD0,L,b","ellL1(E,{r=0}): returns the value at s=1 of the derivative of order r of the L-function of the elliptic curve E."},
...
{"ellan",0,(void*)ellan,12,"GL","ellan(E,n): computes the first n Fourier coefficients of the L-function of the elliptic curve E defined over a number field."},
...
{"ellgroup",0,(void*)ellgroup0,12,"GDGD0,L,","ellgroup(E,{p},{flag}): given an elliptic curve E defined over a finite field Fq, returns the structure of the group E(Fq); for other fields of definition K, p must define a finite residue field (p prime for K = Qp or Q; p a maximal ideal for K a number field) and we return the structure of the (nonsingular) reduction of E. If flag is 1, also returns generators, but the curve equation must be minimal at p."},
{"ellheegner",0,(void*)ellheegner,12,"G","ellheegner(E): return a rational nontorsion point on the elliptic curve E assumed to be of rank 1."},
{"ellheight",0,(void*)ellheight0,12,"GDGDGp","ellheight(E,{P},{Q}): Faltings height of the curve E, resp. canonical height of the point P on elliptic curve E, resp. the value of the attached bilinear form at (P,Q)."},
...
{"ellidentify",0,(void*)ellidentify,12,"G","ellidentify(E): look up the elliptic curve E in the elldata database and return [[N, M, ...], C] where N is the name of the curve in Cremona's database, M the minimal model and C the change of coordinates (see ellchangecurve)."},
...
{"elliscm",0,(void*)elliscm,12,"lG","elliscm(E): return 0 if the elliptic curve E, defined over a number field, is not CM, otherwise return the discriminant of its endomorphism ring."},
...
{"ellisisom",0,(void*)ellisisom,12,"GG","ellisisom(E,F): return 0 if the elliptic curves E and F defined over the same number field are not isomorphic, otherwise return [u,r,s,t] suitable for ellchangecurve, mapping E to F."},
...
{"ellmaninconstant",0,(void*)ellmaninconstant,12,"G","ellmaninconstant(E): let E be an elliptic curve over Q given by ellinit or a rational isogeny class given by ellisomat. Return the Manin constant of the curve, see ellweilcurve. The algorithm is slow but unconditional."},
...
{"ellminimalmodel",0,(void*)ellminimalmodel,12,"GD&","ellminimalmodel(E,{&v}): determines whether the elliptic curve E defined over a number field admits a global minimal model. If so return it and sets v to the corresponding change of variable. Else return the (nonprincipal) Weierstrass class of E."},
...
{"ellnonsingularmultiple",0,(void*)ellnonsingularmultiple,12,"GG","ellnonsingularmultiple(E,P): given E/Q and P in E(Q), returns the pair [R,n] where n is the least positive integer such that R = [n]P has everywhere good reduction. More precisely, its image in a minimal model is everywhere nonsingular."},
{"ellorder",0,(void*)ellorder,12,"GGDG","ellorder(E,z,{o}): order of the point z on the elliptic curve E over a number field or a finite field, 0 if nontorsion. The parameter o, if present, represents a nonzero multiple of the order of z."},
{"ellordinate",0,(void*)ellordinate,12,"GGp","ellordinate(E,x): y-coordinates corresponding to x-ordinate x on elliptic curve E."},
{"ellpadicL",0,(void*)ellpadicL,12,"GGLDGD0,L,DG","ellpadicL(E,p,n,{s=0},{r=0},{D=1}): returns the value on a character of Z_{p}^* represented by an integer s or a vector [s1,s2] of the derivative of order r of the p-adic L-function of the elliptic curve E (twisted by D, if present)."},
...
{"ellpadicfrobenius",0,(void*)ellpadicfrobenius,12,"GUL","ellpadicfrobenius(E,p,n): matrix of the Frobenius at p>2 in the standard basis of H^1_dR(E) to absolute p-adic precision p^n."},
...
{"ellpadiclambdamu",0,(void*)ellpadiclambdamu,12,"GLD1,L,D0,L,","ellpadiclambdamu(E,p,{D=1},{i=0}): returns the Iwasawa invariants for the p-adic L-function attached to E, twisted by (D,.) and the i-th power of the Teichmuller character."},
...
{"ellrank",0,(void*)ellrank,12,"GD0,L,DGp","ellrank(E,{effort=0},{points}): if E is an elliptic curve over Q, attempts to compute the Mordell-Weil group attached to the curve. The output is [r1,r2,s,L], where r1 <= rank(E) <= r2, s gives information on the Tate-Shafarevich group (see documentation), and and L is a list of independent, non-torsion rational points on the curve. E can also be given as the output of ellrankinit(E)."},
{"ellrankinit",0,(void*)ellrankinit,12,"Gp","ellrankinit(E): if E is an elliptic curve over Q, initialize data for further calls to ellrank."},
{"ellratpoints",0,(void*)ellratpoints,12,"GGD0,L,","ellratpoints(E,h,{flag=0}): E being an rational model of an elliptic curve, return a vector containing the affine rational points on the curve of naive height less than h. If fl=1, stop as soon as a point is found."},
...
{"ellsaturation",0,(void*)ellsaturation,12,"GGLp","ellsaturation(E,V,B): let E be an elliptic curve over Q and V be a vector of independent rational points on E of infinite order that generate a subgroup G of E(Q) of finite index. Return a new set W of the same length that generate a subgroup H of E(Q) containing G and such that [E(Q):H] is not divisible by any prime number less than B."},
{"ellsea",0,(void*)ellsea,12,"GD0,L,","ellsea(E,{tors=0}): computes the order of the group E(Fq) for the elliptic curve E, defined over a finite field, using SEA algorithm, with early abort for curves (or their quadratic twist) with nonprime order."},
...
{"ellsupersingularj",0,(void*)ellsupersingularj,12,"G","ellsupersingularj(p): return a random supersingular j-invariant defined over F_p^2 if p is prime number, over the (finite) field of definition of p otherwise"},
...
{"elltaniyama",0,(void*)elltaniyama,12,"GDP","elltaniyama(E,{n=seriesprecision}): modular parametrization of elliptic curve E/Q."},
...
{"elltrace",0,(void*)elltrace,12,"GG","elltrace(E,P): sum of the Galois conjugates of the point P on elliptic curve E."},
{"elltwist",0,(void*)elltwist,12,"GDG","elltwist(E,{P}): returns an ell structure for the twist of the elliptic curve E by the quadratic extension defined by P (when P is a polynomial of degree 2) or quadpoly(P) (when P is an integer). If E is defined over a finite field, then P can be omitted."},
...
{"ellxn",0,(void*)ellxn,12,"GLDn","ellxn(E,n,{v='x}): return polynomials [A,B] in the variable v such that x([n]P) = (A/B)(t) for any P = [t,u] on E outside of n-torsion."},
...
{"eulerfrac",0,(void*)eulerfrac,4,"L","eulerfrac(n): Euler number E_n, as a rational number."},
{"eulerianpol",0,(void*)eulerianpol,4,"LDn","eulerianpol(n,{v='x}): Eulerian polynomial A_n, in variable v."},
{"eulerphi",0,(void*)eulerphi,5,"G","eulerphi(x): Euler's totient function of x."},
{"eulerpol",0,(void*)eulerpol,4,"LDn","eulerpol(n,{v='x}): Euler polynomial E_n, in variable v."},
{"eulerreal",0,(void*)eulerreal,4,"Lp","eulerreal(n): Euler number E_n, as a real number."},
{"eulervec",0,(void*)eulervec,4,"L","eulervec(n): returns a vector containing the nonzero Euler numbers E_0, E_2, ..., E_{2n}."},
...
{"export",0,NULL,1,NULL,"export(x{=...},...,z{=...}): export the variables x,...,z to the parallel world."},
{"exportall",0,(void*)exportall,1,"v","exportall(): declare all current dynamic variables as exported variables."},
...
{"factormodcyclo",0,(void*)factormodcyclo,5,"LGD0,L,Dn","factormodcyclo(n,p,{single=0},{v='x}): factor n-th cyclotomic polynomial mod p."},
...
{"ffinit",0,(void*)ffinit,5,"GLDn","ffinit(p,n,{v='x}): monic irreducible polynomial of degree n in F_p[v]."},
...
{"fflog",0,(void*)fflog,5,"GGDG","fflog(x,g,{o}): return the discrete logarithm of the finite field element x in base g. If present, o must represent the multiplicative order of g. If no o is given, assume that g is a primitive root."},
...
{"ffmaprel",0,(void*)ffmaprel,5,"GG","ffmaprel(m,x): given a (partial) map m between two finite fields, express x as an algebraic element over the codomain of m in a way which is compatible with m. The function is applied recursively to the component of vectors, matrices and polynomials."},
{"ffnbirred",0,(void*)ffnbirred0,5,"GLD0,L,","ffnbirred(q,n,{flag=0}): number of monic irreducible polynomials over F_q, of degree n (flag=0, default) or at most n (flag=1)."},
...
{"fft",0,(void*)FFT,6,"GG","fft(w,P): given w from rootsof1, return the discrete Fourier transform of P."},
{"fftinv",0,(void*)FFTinv,6,"GG","fftinv(w,P): given w from rootsof1, return the inverse Fourier transform of P."},
{"fibonacci",0,(void*)fibo,4,"L","fibonacci(x): Fibonacci number of index x."},
...
{"foreach",0,(void*)foreachpari,1,"vGVI","foreach(V,X,seq): the sequence is evaluated, X running over the components of V."},
{"forell",0,(void*)forell0,1,"vVLLID0,L,","forell(E,a,b,seq,{flag=0}): execute seq for each elliptic curves E of conductor between a and b in the elldata database. If flag is nonzero, select only the first curve in each isogeny class."},
...
{"forprimestep",0,(void*)forprimestep,1,"vV=GDGGI","forprimestep(p=a,b,q,seq): the sequence is evaluated, p running over the primes less than b in the arithmetic progression a + k*q, k >= 0. The parameter q can be a positive integer or an intmod (start at the first prime above a in the progression)."},
{"forqfvec",0,(void*)forqfvec0,7,"vVGDGI","forqfvec(v,q,b,expr): q being a square and symmetric integral matrix representing an positive definite quadratic form, evaluate expr for all pairs of nonzero vectors (-v, v) such that q(v)<=b."},
{"forsquarefree",0,(void*)forsquarefree,1,"vV=GGI","forsquarefree(N=a,b,seq): the sequence is evaluated, N is of the form [n, factor(n)], n going through squarefree integers from a up to b."},
{"forstep",0,(void*)forstep,1,"vV=GGGI","forstep(X=a,b,s,seq): the sequence is evaluated, X going from a to b in steps of s (can be a positive real number, an intmod for an arithmetic progression, or finally a vector of steps). If b is set to +oo the loop will not stop."},
...
{"galoisisabelian",0,(void*)galoisisabelian,10,"GD0,L,","galoisisabelian(gal,{flag=0}): gal being as output by galoisinit, return 0 if gal is not abelian, the HNF matrix of gal over gal.gen if flag=0, 1 if flag is 1, and the SNF matrix of gal if flag=2."},
...
{"gammamellininv",0,(void*)gammamellininv,8,"GGD0,L,b","gammamellininv(G,t,{m=0}): returns G(t), where G is as output by gammamellininvinit (its m-th derivative if m is present)."},
...
{"gcharalgebraic",0,(void*)gcharalgebraic,10,"GDG","gcharalgebraic(gc,{type}): returns a matrix whose columns form a basis of the algebraic Grossencharacters in gc. If type is specified as a vector of integer exponents [p,q] for each complex place, returns a vector containing an algebraic character of that infinity type (or the empty vector if such a character does not exist)."},
{"gcharconductor",0,(void*)gchar_conductor,10,"GG","gcharconductor(gc,chi): returns the conductor of chi, as a modulus over gc.bnf."},
{"gcharduallog",0,(void*)gcharduallog,10,"GG","gcharduallog(gc,chi): returns logarithm vector of character chi in R^n. We have gchareval(gc,chi,x,0) = gcharduallog(gc,chi)*gcharlog(gc,x) in R/Z."},
{"gchareval",0,(void*)gchareval,10,"GGGD1,L,","gchareval(gc,chi,x,{flag=1}): computes the evaluation chi(x) in C* if flag=1 and in C/Z if flag=0."},
{"gcharidentify",0,(void*)gchar_identify,10,"GGGp","gcharidentify(gc,Lv,Lchiv): returns a Grossencharacter chi belonging to gc  that approximately satisfies the constraints that chi_v is Lchiv[i] at the  place v=Lv[i]."},
{"gcharinit",0,(void*)gcharinit,10,"GGp","gcharinit(bnf,f): given a bnf as output by bnfinit and a modulus f, initializes data related to the group of Grossencharacters of conductor dividing this modulus."},
{"gcharisalgebraic",0,(void*)gcharisalgebraic,10,"iGGD&","gcharisalgebraic(gc,chi,{&type}): returns 1 if chi is an algebraic (type A0) character. If type is present, it is set to the infinity type [p,q] of chi."},
{"gcharlocal",0,(void*)gcharlocal,10,"GGGpD&","gcharlocal(gc,chi,v,{&BID}): if v is a place, return the local character chi_v. If v is a prime dividing the modulus and the optional argument 'BID' is present, set BID to the corresponding idealstar structure."},
{"gcharlog",0,(void*)gcharlog,10,"GGp","gcharlog(gc,x): returns the internal representation (logarithm) of the ideal x suitable for computations in gc, as a column vector."},
{"gcharnewprec",0,(void*)gcharnewprec,10,"Gp","gcharnewprec(gc): given a Grossencharacter group \\kbd{gc}, recomputes its invariants to ensure accurate results to current precision."},
{"genus2igusa",0,(void*)genus2igusa,12,"GD0,L,","genus2igusa(PQ,{k}): let PQ be a polynomial P, resp. a vector [P,Q] of polynomials defined over a field F of characteristic != 2. Returns the Igusa invariants of the hyperelliptic curve C/F of genus 2 defined by y^2 = P, resp. y^2 + Q*y = P."},
...
{"getcache",0,(void*)getcache,1,"","getcache(): returns information about various auto-growing caches. For each resource, we report its name, its size, the number of cache misses (since the last extension) and the largest cache miss."},
...
{"getlocalbitprec",0,(void*)getlocalbitprec,1,"lb","getlocalbitprec(): returns the current dynamic bit precision."},
{"getlocalprec",0,(void*)getlocalprec,1,"lp","getlocalprec(): returns the current dynamic precision, in decimal digits."},
...
{"halfgcd",0,(void*)ghalfgcd,5,"GG","halfgcd(x,y): return a vector [M, [a,b]~], where M is an invertible 2x2 matrix such that M*[x,y]~ = [a,b]~, where b is small. More precisely, if x,y are integers, we have b < sqrt(max(|x|,|y|)) <= a. If x,y are polynomials, we have deg b < ceil((max(|x|,|y|))/2) <= deg a."},
{"hammingweight",0,(void*)hammingweight,4,"lG","hammingweight(x): returns the Hamming weight of x."},
{"harmonic",0,(void*)harmonic0,4,"UDG","harmonic(n,{r=1}): generalized harmonic number of index n in power r."},
{"hgmalpha",0,(void*)hgmalpha,14,"G","hgmalpha(H): returns the alpha and beta parameters of the hypergeometric motive template H."},
{"hgmbydegree",0,(void*)hgmbydegree,14,"L","hgmbydegree(n): outputs [L(0),...,L(n-1)] where L(w) is the list of cyclotomic parameters of all possible hypergeometric motive templates of degree n and weight w."},
{"hgmcoef",0,(void*)hgmcoef,14,"GGG","hgmcoef(H,t,n): (H,t) being a hypergeometric motive, returns the n-th coefficient of its L-function."},
{"hgmcoefs",0,(void*)hgmcoefs,14,"GGL","hgmcoefs(H,t,n): (H,t) being a hypergeometric motive, returns the first n coefficients of its L-function, where Euler factors at wild primes are set to 1."},
{"hgmcyclo",0,(void*)hgmcyclo,14,"G","hgmcyclo(H): returns the cyclotomic parameters (D,E) of the hypergeometric motive template H."},
{"hgmeulerfactor",0,(void*)hgmeulerfactor,14,"GGLD&","hgmeulerfactor(H,t,p,{&e}): (H,t) being a hypergeometric motive, returns the Euler factor P_p at the prime p; if present, set e to the valuation of the conductor at p."},
{"hgmgamma",0,(void*)hgmgamma,14,"G","hgmgamma(H): returns the gamma vector of the hypergeometric motive template H."},
{"hgminit",0,(void*)hgminit,14,"GDG","hgminit(a,{b}): Create the template for a hypergeometric motive with parameters a and possibly b. The format of the parameters may be alpha: Galois invariant lists of rational numbers a=alpha and b=beta; or cyclo: lists A and B of positive integers corresponding to alpha and beta; or gamma: list of cn such that the hypergeometric quotient is prod_n(x^n-1)^cn."},
{"hgmissymmetrical",0,(void*)hgmissymmetrical,14,"lG","hgmissymmetrical(H): is the hypergeometric motive template H symmetrical at t=1?"},
{"hgmparams",0,(void*)hgmparams,14,"G","hgmparams(H): H being a hypergeometric motive template, returns [d, w, [P, T], M], where d is the degree, w the weight, P the Hodge polynomial and T the Tate twist number (so that the Hodge function itself is P/x^T); finally M is the so-called M-value."},
{"hgmtwist",0,(void*)hgmtwist,14,"G","hgmtwist(H): twist by 1/2 of alpha and beta of the hypergeometric motive template H."},
{"hilbert",0,(void*)hilbert,5,"lGGDG","hilbert(x,y,{p}): Hilbert symbol at p of x,y."},
{"hyperellchangecurve",0,(void*)hyperellchangecurve,12,"GG","hyperellchangecurve(C,m): C being a nonsingular hyperelliptic model of a curve, apply the change of coordinate given by m. C can be given either by a squarefree polynomial P such that C:y^2=P(x) or by a vector [P,Q] such that C:y^2+Q(x)*y=P(x) and Q^2+4P is squarefree."},
{"hyperellcharpoly",0,(void*)hyperellcharpoly,12,"G","hyperellcharpoly(X): X being a nonsingular hyperelliptic curve defined over a finite field, return the characteristic polynomial of the Frobenius automorphism.  X can be given either by a squarefree polynomial P such that X:y^2=P(x) or by a vector [P,Q] such that X:y^2+Q(x)*y=P(x) and Q^2+4P is squarefree."},
{"hyperelldisc",0,(void*)hyperelldisc,12,"G","hyperelldisc(X): X being a nonsingular hyperelliptic model of a curve, defined over a field of characteristic distinct from 2, returns its discriminant. X can be given either by a squarefree polynomial P such that X:y^2=P(x) or by a vector [P,Q] such that X:y^2+Q(x)*y=P(x) and Q^2+4P is squarefree."},
{"hyperellisoncurve",0,(void*)hyperellisoncurve,12,"iGG","hyperellisoncurve(X,p): X being a nonsingular hyperelliptic model of a curve, test whether the point p is on the curve. X can be given either by a squarefree polynomial P such that X:y^2=P(x) or by a vector [P,Q] such that X:y^2+Q(x)*y=P(x) and Q^2+4P is squarefree."},
{"hyperellminimaldisc",0,(void*)hyperellminimaldisc,12,"GDG","hyperellminimaldisc(C,{pr}): C being a nonsingular integral hyperelliptic model of a curve, return the minimal discrminant of an integral model of C.  If pr is given, it must be a list of primes and the discriminant is then only garanteed minimal at the elements of pr. C can be given either by a squarefree polynomial P such that C:y^2=P(x) or by a vector [P,Q] such that C:y^2+Q(x)*y=P(x) and Q^2+4P is squarefree."},
{"hyperellminimalmodel",0,(void*)hyperellminimalmodel,12,"GD&DG","hyperellminimalmodel(C,{&m},{pr}): C being a nonsingular integral hyperelliptic model of a curve, return an integral model of C with minimal discriminant. If pr is given, it must be a list of primes and the model is then only garanteed minimal at the elements of pr. C can be given either by a squarefree polynomial P such that C:y^2=P(x) or by a vector [P,Q] such that C:y^2+Q(x)*y=P(x) and Q^2+4P is squarefree."},
{"hyperellordinate",0,(void*)hyperellordinate,12,"GG","hyperellordinate(H,x): y-coordinates corresponding to x-ordinate x on hyperelliptic curve H."},
{"hyperellpadicfrobenius",0,(void*)hyperellpadicfrobenius0,12,"GGL","hyperellpadicfrobenius(Q,q,n): Q being a rational polynomial of degree d and X being the curve defined by y^2=Q(x), return the matrix of the Frobenius at the prime q >= d in the standard basis of H^1_dR(X) to absolute q-adic precision q^n; q may also be of the form [T,p] where T is an integral polynomial which is irreducible mod p."},
...
{"hyperellred",0,(void*)hyperellred,12,"GD&","hyperellred(C,{&m}): C being a nonsingular integral hyperelliptic model of a curve, return an integral model of C with the same discriminant but small coefficients. C can be given either by a squarefree polynomial P such that C:y^2=P(x) or by a vector [P,Q] such that C:y^2+Q(x)*y=P(x) and Q^2+4P is squarefree."},
{"hypergeom",0,(void*)hypergeom,8,"DGDGGp","hypergeom({N},{D},z): general hypergeometric function, where N and D are the vector of parameters in the numerator and denominator respectively, evaluated at the argument z."},
{"hyperu",0,(void*)hyperu,8,"GGGp","hyperu(a,b,z): U-confluent hypergeometric function."},
...
{"idealdiv",0,(void*)idealdiv0,10,"GGGD0,L,","idealdiv(nf,x,y,{flag=0}): quotient x/y of two ideals x and y in HNF in the number field nf. If (optional) flag is nonzero, the quotient is supposed to be an integral ideal (slightly faster)."},
{"idealdown",0,(void*)idealdown,10,"GG","idealdown(nf,x): finds the intersection of the ideal x with Q."},
...
{"idealfactorback",0,(void*)idealfactorback,10,"GGDGD0,L,","idealfactorback(nf,f,{e},{flag = 0}): given a factorization f, gives the ideal product back. If e is present, f has to be a vector of the same length, and we return the product of the f[i]^e[i]. If flag is nonzero, perform idealred along the way."},
...
{"idealismaximal",0,(void*)idealismaximal,10,"GG","idealismaximal(nf,x): if x is a maximal ideal, return it in prid form, else return 0."},
{"idealispower",0,(void*)idealispower,10,"lGGLD&","idealispower(nf,A,n,{&B}): return 1 if A = B^n is an n-th power else return 0."},
{"ideallist",0,(void*)gideallist,10,"GGD4,L,","ideallist(nf,bound,{flag=4}): vector of vectors L of all idealstar of all ideals of norm<=bound. If (optional) flag is present, its binary digits are toggles meaning 1: give generators; 2: add units; 4: give only the ideals and not the bid; 8: omit ideals which cannot be conductors."},
...
{"idealmul",0,(void*)idealmul0,10,"GGGD0,L,","idealmul(nf,x,y,{flag=0}): product of the two ideals x and y in the number field nf. If (optional) flag is nonzero, reduce the result."},
...
{"idealpow",0,(void*)idealpow0,10,"GGGD0,L,","idealpow(nf,x,k,{flag=0}): k-th power of the ideal x in HNF in the number field nf. If (optional) flag is nonzero, reduce the result."},
{"idealprimedec",0,(void*)idealprimedec_limit_f,10,"GGD0,L,","idealprimedec(nf,p,{f=0}): prime ideal decomposition of the prime number p in the number field nf as a vector of prime ideals. If f is present and nonzero, restrict the result to primes of residue degree <= f."},
...
{"inline",0,NULL,1,NULL,"inline(x,...,z): declares x,...,z as inline variables. DEPRECATED, use export."},
...
{"ispower",0,(void*)ispower,5,"lGDGD&","ispower(x,{k},{&n}): if k > 0 is given, return true (1) if x is a k-th power, false (0) if not. If k is omitted, return the maximal k >= 2 such that x = n^k is a perfect power, or 0 if no such k exist. If n is present, and the function returns a nonzero result, set n to the k-th root of x."},
...
{"isprimepower",0,(void*)isprimepower,5,"lGD&","isprimepower(x,{&n}): if x = p^k is a prime power (p prime, k > 0), return k, else return 0. If n is present, and the function returns a nonzero result, set n to p, the k-th root of x."},
...
{"ispseudoprimepower",0,(void*)ispseudoprimepower,5,"lGD&","ispseudoprimepower(x,{&n}): if x = p^k is a pseudo-prime power (p pseudo-prime, k > 0), return k, else return 0. If n is present, and the function returns a nonzero result, set n to p, the k-th root of x."},
...
{"lambertw",0,(void*)glambertW,8,"GD0,L,p","lambertw(y,{branch=0}): solution of the implicit equation x*exp(x)=y. In the p-adic case, give a solution of x*exp(x)=y if y has valuation > 1 (or p odd and positive valuation), of log(x)+x=log(y) otherwise."},
...
{"lerchphi",0,(void*)lerchphi,8,"GGGp","lerchphi(z,s,a): Lerch transcendent equal to sum for n >= 0 of z^n / (n+a)^s for reasonable values of the arguments."},
{"lerchzeta",0,(void*)lerchzeta,8,"GGGp","lerchzeta(s,a,lam): Lerch zeta function equal to sum for n >= 0 of e^(2 pi i lam n) / (n+a)^s for reasonable values of the arguments."},
...
{"lfunconductor",0,(void*)lfunconductor,13,"GDGD0,L,b","lfunconductor(L,{setN=10000},{flag=0}): gives the conductor of the given L-function, expecting to find it in the interval [1,setN]. If flag=0 (default), gives either the conductor found as an integer, or a vector of conductors found, possibly empty. If flag=1, same but gives the computed floating point approximations to the conductors found, without rounding to integers. If flag=2, gives all the conductors found, even those far from integers. Alternatively, setN can contain a list of possible conductors and we select the best one according to lfuncheckfeq; in this case, flag is ignored and we return [N, lfuncheckfeq for that N]."},
...
{"lfundual",0,(void*)lfundual,13,"Gb","lfundual(L): creates the Ldata structure (without initialization) corresponding to the dual L-function of L."},
...
{"lfuneuler",0,(void*)lfuneuler,13,"GGp","lfuneuler(L,p): return the Euler factor at p  of the L-function given by L (Lmath, Ldata or Linit) assuming the L-function  admits an Euler product factorization and that it can be determined."},
{"lfungenus2",0,(void*)lfungenus2,13,"G","lfungenus2(F): returns the Ldata structure attached to the L-function attached to the genus-2 curve defined by y^2=F(x) or y^2+Q(x)*y=P(x) if F=[P,Q]. Currently, only odd conductors are supported."},
...
{"lfunmf",0,(void*)lfunmf,15,"GDGb","lfunmf(mf,{F}): If F is a modular form in mf, output the L-functions corresponding to its complex embeddings. If F is omitted, output the L-functions corresponding to all eigenforms in the new space."},
{"lfunmfspec",0,(void*)lfunmfspec,13,"Gb","lfunmfspec(L): L corresponding to a modular eigenform, returns [vo,ve,om,op] in even weight, where vo (resp., ve) is the vector of odd (resp., even) periods, and om and op the corresponding real numbers omega^- and omega^+. Returns [v,om] in odd weight."},
...
{"lfunorderzero",0,(void*)lfunorderzero,13,"lGD-1,L,b","lfunorderzero(L,{m=-1}): computes the order of the possible zero of the L-function at the center k/2 of the critical strip. If m is given and has a nonnegative value, assumes the order is at most m."},
{"lfunparams",0,(void*)lfunparams,13,"Gp","lfunparams(ldata): returns the parameters [N, k, vga] of the L-function  defined by ldata (see lfuncreate).  The parameters Vga (gamma shifts) are returned to the current precision."},
...
{"lfunrootres",0,(void*)lfunrootres,13,"Gb","lfunrootres(data): given the Ldata attached to an L-function (or the output of lfunthetainit), compute the root number and the residues. In the present implementation, if the polar part is not already known completely, at most a single pole is allowed. The output is a 3-component vector  [[[a_1, r_1],...,[a_n, r_n],[[b_1, R_1],...[b_m,R_m]]~, w], where r_i is the  polar part of L(s) at a_i, R_i is is the polar part of Lambda(s) at b_i,  or [0,0,r] if there is no pole, and r is the root number."},
{"lfunshift",0,(void*)lfunshift,13,"GGD0,L,b","lfunshift(L,d,{flag}): creates the Ldata structure (without initialization) corresponding to the function Ld such that Ld(s) = L(s-d). If fl=1, return the product L*Ld instead."},
...
{"lfuntwist",0,(void*)lfuntwist,13,"GGb","lfuntwist(L,chi): creates the Ldata structure (without initialization) corresponding to the twist of L by the primitive character attached to the Dirichlet L-function chi. This requires that the conductor of the character is coprime to the conductor of the L-function L."},
...
{"liftint",0,(void*)liftint,3,"G","liftint(x): lifts every element of Z/nZ to Z and of Qp to Q."},
{"liftpol",0,(void*)liftpol,3,"G","liftpol(x): lifts every polmod component of x to polynomials."},
{"limitnum",0,(void*)limitnum0,9,"GDGp","limitnum(expr,{alpha=1}): numerical limit of sequence expr using Lagrange-Zagier extrapolation; assume u(n) ~ sum a_i n^(-alpha*i)."},
...
{"listinsert",0,(void*)listinsert0,1,"mWGL","listinsert(~L,x,n): insert x at index n in list L, shifting the remaining elements to the right."},
{"listkill",0,(void*)listkill,1,"vW","listkill(~L): obsolete, retained for backward compatibility."},
...
{"listput",0,(void*)listput0,1,"mWGD0,L,","listput(~list,x,{n}): sets n-th element of list equal to x. If n is omitted or greater than the current list length, appends x."},
{"listsort",0,(void*)listsort,1,"vWD0,L,","listsort(~L,{flag=0}): sort the list L in place. If flag is nonzero, suppress all but one occurrence of each element in list."},
...
{"localbitprec",0,(void*)localbitprec,1,"vG","localbitprec(p): set the real precision to p bits in the dynamic scope."},
{"localprec",0,(void*)localprec,1,"vG","localprec(p): set the real precision to p in the dynamic scope and return p."},
{"log",0,(void*)glog,8,"Gp","log(x): natural logarithm of x."},
{"log1p",0,(void*)glog1p,8,"Gp","log1p(x): log(1+x)"},
{"logint",0,(void*)logint0,5,"lGGD&","logint(x,b,{&z}): return the largest non-negative integer e so that b^e <= x, where b > 1 is an integer and x >= 1 is a real number. If the parameter z is present, set it to b^e."},
{"mapapply",0,(void*)mapapply,1,"WGGDG","mapapply(~M,x,f,{u}): applies the closure f to the image of x by the map M and returns the evaluation of f."},
{"mapdelete",0,(void*)mapdelete,1,"vWG","mapdelete(~M,x): removes x from the domain of the map M."},
...
{"matadjoint",0,(void*)matadjoint0,7,"GD0,L,","matadjoint(M,{flag=0}): adjoint matrix of M using Leverrier-Faddeev's algorithm. If flag is 1, computes the characteristic polynomial independently first."},
...
{"mathnfmod",0,(void*)hnfmod,7,"GG","mathnfmod(x,d): (upper triangular) Hermite normal form of x, basis for the lattice formed by the columns of x, where d is a multiple of the nonzero determinant of this lattice."},
...
{"matker",0,(void*)matker0,7,"GD0,L,","matker(x,{flag=0}): basis of the kernel of the matrix x. flag is optional, and may be set to 0: default; nonzero: x is known to have integral entries."},
{"matkerint",0,(void*)matkerint0,7,"GD0,L,","matkerint(x,{flag=0}): LLL-reduced Z-basis of the kernel of the matrix x with integral entries; flag is deprecated, kept for backward compatibility."},
...
{"matreduce",0,(void*)matreduce,7,"G","matreduce(m): reduce the factorization matrix m to canonical form (sorted first row with unique elements) matrix."},
...
{"matsolvemod",0,(void*)matsolvemod,7,"GGGD0,L,","matsolvemod(M,D,B,{flag=0}): one solution of system of congruences MX=B mod D (M matrix, B and D column vectors). If (optional) flag is nonzero return all solutions."},
...
{"mfDelta",0,(void*)mfDelta,15,"","mfDelta(): mf corresponding to the Ramanujan Delta function."},
{"mfEH",0,(void*)mfEH,15,"G","mfEH(k): k>0 being in 1/2+Z, mf corresponding to the Cohen-Eisenstein series H_k of weight k on G_0(4)."},
{"mfEk",0,(void*)mfEk,15,"L","mfEk(k): mf corresponding to the standard Eisenstein series E_k for nonnegative even integer k."},
{"mfTheta",0,(void*)mfTheta,15,"DG","mfTheta({psi=1}): the unary theta function corresponding to the primitive Dirichlet character psi, hence of weight 1/2 if psi is even, of weight 3/2 if psi is odd."},
{"mfatkin",0,(void*)mfatkin,15,"GG","mfatkin(mfatk,f): Given an mfatk output by mfatk = mfatkininit(mf,Q) and a modular form f belonging to the space mf, returns the modular form g = C*f|W_Q where C = mfatk[3] is a normalizing constant so that g has the same field of coefficients as f; mfatk[1] = mf2 (or 0 if mf2=mf) which is the space to which g belongs."},
{"mfatkineigenvalues",0,(void*)mfatkineigenvalues,15,"GLp","mfatkineigenvalues(mf,Q): given a modular form space mf and a primitive divisor Q of the level of mf, outputs the corresponding Atkin-Lehner eigenvalues on the new space, grouped by orbit."},
{"mfatkininit",0,(void*)mfatkininit,15,"GLp","mfatkininit(mf,Q): initializes data necessary for working with Atkin--Lehner operators W_Q, for now only the function mfatkin. The result is a 4-component vector [mfB, MC, C, mf] where mfB is either 0 or the possibly different modular form space to which F|W_Q will belong (this does not depend on F in mf); MC is the matrix of W_Q on the basis of mf multiplied by a normalizing constant C."},
{"mfbasis",0,(void*)mfbasis,15,"GD4,L,","mfbasis(NK,{space=4}): If NK=[N,k,CHI] as in mfinit, gives a basis of the corresponding subspace of M_k(G_0(N),CHI). NK can also be the output of mfinit, in which case space is ignored. To obtain the eigenforms use mfeigenbasis."},
{"mfbd",0,(void*)mfbd,15,"GL","mfbd(F,d): F being a generalized modular form, return B(d)(F), where B(d) is the expanding operator tau -> d tau."},
{"mfbracket",0,(void*)mfbracket,15,"GGD0,L,","mfbracket(F,G,{m=0}): compute the m-th Rankin-Cohen bracket of the generalized modular forms F and G."},
{"mfcoef",0,(void*)mfcoef,15,"GL","mfcoef(F,n): Compute the n-th Fourier coefficient a(n) of the generalized modular form F."},
{"mfcoefs",0,(void*)mfcoefs,15,"GLD1,L,","mfcoefs(F,n,{d=1}): Compute the vector of coefficients [a[0],a[d],...,a[nd]] of the modular form F."},
{"mfconductor",0,(void*)mfconductor,15,"lGG","mfconductor(mf,F): mf being output by mfinit and F a modular form, gives the smallest level at which F is defined."},
{"mfcosets",0,(void*)mfcosets,15,"G","mfcosets(N): list of right cosets of G_0(N)\\G, i.e., matrices g_j in G such that G = U G_0(N) g_j. The g_j are chosen in the form [a,b; c,d] with c | N."},
{"mfcuspisregular",0,(void*)mfcuspisregular,15,"lGG","mfcuspisregular(NK,cusp): In the space defined by NK = [N,k,CHI] or NK = mf, determine if cusp in canonical format (oo or denominator dividing N) is regular or not."},
{"mfcusps",0,(void*)mfcusps,15,"G","mfcusps(N): list of cusps of G_0(N) in the form a/b with b dividing N."},
{"mfcuspval",0,(void*)mfcuspval,15,"GGGb","mfcuspval(mf,F,cusp): valuation of modular form F in the space mf at cusp, which can be either oo or any rational number. The result is either a rational number or oo if F is zero. Let chi be the Nebentypus of the space mf; if Q(F) != Q(chi), return the vector of valuations attached to the [Q(F):Q(chi)] complex embeddings of F."},
{"mfcuspwidth",0,(void*)mfcuspwidth,15,"lGG","mfcuspwidth(N,cusp): width of cusp in Gamma_0(N)."},
{"mfderiv",0,(void*)mfderiv,15,"GD1,L,","mfderiv(F,{m=1}): m-th formal derivative of the power series corresponding to the generalized modular form F, with respect to the differential operator q.d/dq (default m=1)."},
{"mfderivE2",0,(void*)mfderivE2,15,"GD1,L,","mfderivE2(F,{m=1}): compute the Serre derivative (q.d/dq)F - kE_2F/12 of the generalized modular form F of weight k; and if m > 1, the m-th iterate."},
{"mfdescribe",0,(void*)mfdescribe,15,"GD&","mfdescribe(F,{&G}): gives a human-readable description of F, which is either a modular form space or a modular form. If the address of G is given, puts into G the vector of parameters of the outmost operator defining F."},
{"mfdim",0,(void*)mfdim,15,"GD4,L,","mfdim(NK,{space=4}): If NK=[N,k,CHI] as in mfinit, gives the dimension of the corresponding subspace of M_k(G_0(N),chi). The subspace is described by a small integer 'space': 0 for the newspace, 1 for the cuspidal space, 2 for the oldspace, 3 for the space of Eisenstein series and 4 (default) for the full space M_k. NK can also be the output of mfinit, in which case space must be omitted."},
{"mfdiv",0,(void*)mfdiv,15,"GG","mfdiv(F,G): compute F/G for two modular forms F and G assuming that the quotient will not have poles at infinity. If this is the case, use mfshift before doing the division."},
{"mfeigenbasis",0,(void*)mfeigenbasis,15,"G","mfeigenbasis(mf): vector of the eigenforms for the space mf."},
{"mfeigensearch",0,(void*)mfeigensearch,15,"GDG","mfeigensearch(NK,{AP}): search for normalized rational eigen cuspforms with quadratic characters given a few initial coefficients. The meaning of the parameters is as follows:  NK is of the form [N,k]: search given level N, weight k and quadratic character; note that the character is uniquely determined by (N,k). The level N can be replaced by a vector of allowed levels.  AP is the search criterion, which can be omitted: a list of pairs [...,[p,a_p],...], where a_p is either a t_INT (exact match) or a t_INTMOD (match modulo the given integer).  The result is a vector of newforms matching the search criteria, sorted by increasing level."},
{"mfeisenstein",0,(void*)mfeisenstein,15,"LDGDG","mfeisenstein(k,{CHI1},{CHI2}): create the Eisenstein E_k(CHI1,CHI2), where an omitted character is considered as trivial."},
{"mfembed",0,(void*)mfembed0,15,"GDGp","mfembed(f,{v}): if v is omitted, f must be a modular form or a modular form space with parameters [N,k,chi] and we return a vector of complex embeddings of Q(f) or Q(chi), respectively.  If v is given, it must be a scalar in Q(f), or a vector/matrix of such, we apply the embeddings coefficientwise and return a vector of results. Finally f can be replaced by a single embedding produced by mfembed(f) and we apply that particular embedding to v. Note that, in our context, Q(chi) has a single canonical embeding given by s: Mod(t, polcyclo(n,t)) -> exp(2*I*Pi/n) and Q(f) has [Q(f):Q(chi)] induced embeddings attached to the complex roots of s(P) where P = mfparams(f)[4], as ordered by polroots. In the latter case, we only support an f with Q(f) = Q(chi) or an eigenform produced by mfeigenbasis."},
{"mfeval",0,(void*)mfeval,15,"GGGb","mfeval(mf,F,vtau): computes the numerical value of the modular form F at the point vtau or the vector vtau of points in the completed upper-half plane."},
{"mffields",0,(void*)mffields,15,"G","mffields(mf): If mf is output by mfinit, gives the vector of polynomials defining each Galois orbit of the new space."},
{"mffromell",0,(void*)mffromell,15,"G","mffromell(E): E being an elliptic curve defined over Q given by an integral model in ellinit format, computes a 3-component vector [mf,F,v], where F is the newform corresponding to E by modularity, mf is the newspace to which F belongs, and v gives the coefficients of F on mfbasis(mf)."},
{"mffrometaquo",0,(void*)mffrometaquo,15,"GD0,L,","mffrometaquo(eta,{flag=0}): modular form corresponding to the eta quotient matrix eta. If the valuation v at infinity is fractional, returns 0. If the eta quotient is not holomorphic but simply meromorphic, returns 0 if flag=0; returns the eta quotient (divided by q to the power -v if v < 0, i.e., with valuation 0) if flag is set."},
{"mffromlfun",0,(void*)mffromlfun,15,"Gp","mffromlfun(L): L being an L-function representing a self-dual modular form, return [NK,space,v] where mf=mfinit(NK,space) contains the form and mftobasis(mf, v) containing it and v is mftobasis(mf,f)."},
{"mffromqf",0,(void*)mffromqf,15,"GDG","mffromqf(Q,{P}): Q being an even positive definite quadratic form and P a homogeneous spherical polynomial for Q, computes a 3-component vector [mf,F,coeffs], where F is the theta function corresponding to (Q, P), mf is the corresponding space of modular forms from mfinit, and coeffs are the coefficients of F on mfbasis(mf)."},
{"mfgaloisprojrep",0,(void*)mfgaloisprojrep,15,"GGp","mfgaloisprojrep(mf,F): mf being an mf output by mfinit in weight 1, and F an eigenform, returns a polynomial defining the field fixed by the kernel of the projective representation associated to F."},
{"mfgaloistype",0,(void*)mfgaloistype,15,"GDG","mfgaloistype(NK,{F}): NK being either [N,1,CHI] or an mf output by mfinit in weight 1 , gives the vector of types of Galois representations attached to each cuspidal eigenform, unless the eigenform F is specified, in which case only for F. Types A_4, S_4, A_5 are represented by minus their cardinality -12, -24, or -60, and type D_n is represented by its cardinality, the integer 2*n."},
{"mfhecke",0,(void*)mfhecke,15,"GGL","mfhecke(mf,F,n): F being a modular form in space mf, returns T(n)F, where T(n) is the n-th Hecke operator. Warning: if F is of level M<N, T(n)F is in general not the same in M_k(G_0(M),CHI) and in M_k(G_0(N),CHI). We take T(n) at the same level as the one used in mf."},
{"mfheckemat",0,(void*)mfheckemat,15,"GG","mfheckemat(mf,vecn): if vecn is an integer, matrix of the Hecke operator T(n) on the basis formed by mfbasis(mf), if it is a vector, vector of such matrices."},
{"mfinit",0,(void*)mfinit,15,"GD4,L,","mfinit(NK,{space=4}): Create the space of modular forms corresponding to the data contained in NK and space. NK is a vector which can be either [N,k] (N level, k weight) corresponding to a subspace of M_k(G_0(N)), or [N,k,CHI] (CHI a character) corresponding to a subspace of M_k(G_0(N),chi). The subspace is described by a small integer 'space': 0 for the newspace, 1 for the cuspidal space, 2 for the oldspace, 3 for the space of Eisenstein series and 4 (default) for the full space M_k"},
{"mfisCM",0,(void*)mfisCM,15,"G","mfisCM(F): Tests whether the eigenform F is a CM form. The answer is 0 if it is not, and if it is, either the unique negative discriminant of the CM field, or the pair of two negative discriminants of CM fields, this latter case occurring only in weight 1 when the projective image is D2=C2xC2, i.e., coded 4 by mfgaloistype."},
{"mfisequal",0,(void*)mfisequal,15,"lGGD0,L,","mfisequal(F,G,{lim=0}): Checks whether the modular forms F and G are equal. If lim is nonzero, only check equality of the first lim+1 Fourier coefficients."},
{"mfisetaquo",0,(void*)mfisetaquo,15,"GD0,L,","mfisetaquo(f,{flag=0}): if the generalized modular form f is a holomorphic eta quotient, return the eta quotient matrix, else return 0. If flag is set, also accept meromorphic eta quotients."},
{"mfkohnenbasis",0,(void*)mfkohnenbasis,15,"G","mfkohnenbasis(mf): mf being a cuspidal space of half-integral weight k >= 3/2, gives a basis B of the Kohnen + space of mf as a matrix whose columns are the coefficients of B on the basis of mf."},
{"mfkohnenbijection",0,(void*)mfkohnenbijection,15,"G","mfkohnenbijection(mf): mf being a cuspidal space of half-integral weight returns [mf2,M,K,shi], where M is a matrix giving a Hecke-module isomorphism from S_{2k-1}(N,CHI^2) given by mf2 to the Kohnen + space S_k+(4N,CHI), K is a basis of the Kohnen + space, and shi gives the linear combination of Shimura lifts giving M^(-1)."},
{"mfkohneneigenbasis",0,(void*)mfkohneneigenbasis,15,"GG","mfkohneneigenbasis(mf,bij): mf being a cuspidal space of half-integral weight k >= 3/2 and bij being the output of mfkohnenbijection(mf), outputs a 3-component vector [mf0,BNEW,BEIGEN], where BNEW and BEIGEN are two matrices whose columns are the coefficients of a basis of the Kohnen new space and of the eigenforms on the basis of mf respectively, and mf0 is the corresponding new space of integral weight 2k - 1."},
{"mflinear",0,(void*)mflinear,15,"GG","mflinear(vF,v): vF being a vector of modular forms and v a vector of coefficients of same length, compute the linear combination of the entries of vF with coefficients v."},
{"mfmanin",0,(void*)mfmanin,15,"Gb","mfmanin(FS): Given the modular symbol FS associated to an eigenform F by mfsymbol(mf,F), computes the odd and even special polynomials as well as the odd and even periods om- and om+ as a vector [[P-,P+],[om-,om+,r]], where r = imag(om+*conj(om-))/<F,F>. If F has several embeddings into C, give the vector of results corresponding to each embedding."},
{"mfmul",0,(void*)mfmul,15,"GG","mfmul(F,G): Multiply the two forms F and G."},
{"mfnumcusps",0,(void*)mfnumcusps,15,"G","mfnumcusps(N): number of cusps of Gamma_0(N)"},
...
{"msatkinlehner",0,(void*)msatkinlehner,16,"GLDG","msatkinlehner(M,Q,{H}): M being a full modular symbol space of level N, as given by msinit, let Q | N, (Q,N/Q) = 1, and let H be a subspace stable under the Atkin-Lehner involution w_Q. Return the matrix of w_Q acting on H (M if omitted)."},
...
{"mscuspidal",0,(void*)mscuspidal,16,"GD0,L,","mscuspidal(M,{flag=0}): M being a full modular symbol space, as given by msinit, return its cuspidal part S. If flag = 1, return [S,E] its decomposition into Eisenstein and cuspidal parts."},
{"msdim",0,(void*)msdim,16,"lG","msdim(M): M being a modular symbol space or subspace, return its dimension as a Q-vector space."},
{"mseisenstein",0,(void*)mseisenstein,16,"G","mseisenstein(M): M being a full modular symbol space, as given by msinit, return its Eisenstein subspace."},
{"mseval",0,(void*)mseval,16,"GGDG","mseval(M,s,{p}): M being a full modular symbol space, as given by msinit, s being a modular symbol from M and p being a path between two elements in P^1(Q), return s(p)."},
{"msfarey",0,(void*)msfarey0,16,"GGD&","msfarey(F,inH,{&CM}): F being a Farey symbol attached to a group G contained in SL2(Z) and H a subgroup of G, return a Farey symbol attached to H; H is given by a criterion inH (closure) deciding whether an element of G belongs to H."},
{"msfromcusp",0,(void*)msfromcusp,16,"GG","msfromcusp(M,c): returns the modular symbol attached to the cusp c, where M is a modular symbol space of level N."},
{"msfromell",0,(void*)msfromell,16,"GD0,L,","msfromell(E,{sign=0}): return the [M, x], where M is msinit(N,2) and x is the modular symbol in M attached to the elliptic curve E/Q."},
{"msfromhecke",0,(void*)msfromhecke,16,"GGDG","msfromhecke(M,v,{H}): given a msinit M and a vector v of pairs [p, P] (where p is prime and P is a polynomial with integer coefficients), return a basis of all modular symbols such that P(Tp) * s = 0. If H is present, it must be a Hecke-stable subspace and we restrict to s in H."},
{"msgetlevel",0,(void*)msgetlevel,16,"lG","msgetlevel(M): M being a full modular symbol space, as given by msinit, return its level N."},
{"msgetsign",0,(void*)msgetsign,16,"lG","msgetsign(M): M being a full modular symbol space, as given by msinit, return its sign."},
{"msgetweight",0,(void*)msgetweight,16,"lG","msgetweight(M): M being a full modular symbol space, as given by msinit, return its weight k."},
{"mshecke",0,(void*)mshecke,16,"GLDG","mshecke(M,p,{H}): M being a full modular symbol space, as given by msinit, p being a prime number, and H being a Hecke-stable subspace (M if omitted), return the matrix of T_p acting on H (U_p if p divides the level)."},
{"msinit",0,(void*)msinit,16,"GGD0,L,","msinit(G,V,{sign=0}): given G a finite index subgroup of SL(2,Z) and a finite dimensional representation V of GL(2,Q), creates a space of modular symbols, the G-module Hom_G(Div^0(P^1 Q), V). This is canonically isomorphic to H^1_c(X(G), V), and allows to compute modular forms for G. If sign is present and nonzero, it must be +1 or -1 and we consider the subspace defined by Ker (Sigma - sign), where Sigma is induced by [-1,0;0,1]. Currently the only supported groups are the Gamma_0(N), coded by the integer N. The only supported representation is V_k = Q[X,Y]_{k-2}, coded by the integer k >= 2."},
{"msissymbol",0,(void*)msissymbol,16,"GG","msissymbol(M,s): M being a full modular symbol space, as given by msinit, check whether s is a modular symbol attached to M."},
{"mslattice",0,(void*)mslattice,16,"GDG","mslattice(M,{H}): M being a full modular symbol space, as given by msinit, H a Q-subspace or a matrix of modular symbols. Return the canonical integral structure of H."},
{"msnew",0,(void*)msnew,16,"G","msnew(M): M being a full modular symbol space, as given by msinit, return its new cuspidal subspace."},
{"msomseval",0,(void*)msomseval,16,"GGG","msomseval(Mp,PHI,path): return the vectors of moments of the p-adic distribution attached to the path 'path' via the overconvergent modular symbol 'PHI'."},
{"mspadicL",0,(void*)mspadicL,16,"GDGD0,L,","mspadicL(mu,{s=0},{r=0}): given mu from mspadicmoments (p-adic distributions attached to an overconvergent symbol PHI) returns the value on a character of Z_p^* represented by s of the derivative of order r of the p-adic L-function attached to PHI."},
...
{"mspadicmoments",0,(void*)mspadicmoments,16,"GGD1,L,","mspadicmoments(Mp,PHI,{D=1}): given Mp from mspadicinit, an overconvergent eigensymbol PHI, and optionally a fundamental discriminant D coprime to p, return the moments of the p-1 distributions PHI^D([0]-[oo]) | (a + pZp), 0 < a < p. To be used by mspadicL and mspadicseries."},
{"mspadicseries",0,(void*)mspadicseries,16,"GD0,L,","mspadicseries(mu,{i=0}): given mu from mspadicmoments, returns the attached p-adic series with maximal p-adic precision, depending on the precision of M (i-th Teichmueller component, if present)."},
{"mspathgens",0,(void*)mspathgens,16,"G","mspathgens(M): M being a full modular symbol space, as given by msinit, return a set of Z[G]-generators for Div^0(P^1 Q). The output is [g,R], where g is a minimal system of generators and R the vector of Z[G]-relations between the given generators."},
{"mspathlog",0,(void*)mspathlog,16,"GG","mspathlog(M,p): M being a full modular symbol space, as given by msinit and p being a path between two elements in P^1(Q), return (p_i) in Z[G] such that p = \\sum p_i g_i, and the g_i are fixed Z[G]-generators for Div^0(P^1 Q), see mspathgens."},
{"mspetersson",0,(void*)mspetersson,16,"GDGDG","mspetersson(M,{F},{G=F}): M being a full modular symbol space, as given by msinit, calculate the intersection product {F,G} of modular symbols F and G on M."},
{"mspolygon",0,(void*)mspolygon,16,"GD0,L,","mspolygon(M,{flag=0}): M describes a subgroup G of finite index in the modular group PSL2(Z), as given by msinit or a positive integer N (encoding the group G = Gamma0(N)), or by msfarey (arbitrary subgroups). Return an hyperbolic polygon (Farey symbol) attached to G. Binary digits of flag mean: 1=normalized polygon, 2=also add graphical representations."},
{"msqexpansion",0,(void*)msqexpansion,16,"GGDP","msqexpansion(M,projH,{B = seriesprecision}): M being a full modular symbol space, as given by msinit, and projH being a projector on a Hecke-simple subspace, return the Fourier coefficients [a_n, n <= B] of the corresponding normalized newform. If B omitted, use seriesprecision."},
{"mssplit",0,(void*)mssplit,16,"GDGD0,L,","mssplit(M,{H},{dimlim}): M being a full modular symbol space, as given by msinit, and H being a subspace (the new subspace if omitted), split H into Hecke-simple subspaces. If dimlim is present and positive, restrict to dim <= dimlim."},
{"msstar",0,(void*)msstar,16,"GDG","msstar(M,{H}): M being a full modular symbol space, as given by msinit, return the matrix of the * involution, induced by complex conjugation, acting on the (stable) subspace H (M if omitted)."},
{"mstooms",0,(void*)mstooms,16,"GG","mstooms(Mp,phi): given Mp from mspadicinit, lift the (classical) eigen symbol phi to a distribution-valued overconvergent symbol in the sense of Pollack and Stevens. The resulting overconvergent eigensymbol can then be used in mspadicmoments, then mspadicL or mspadicseries."},
...
{"nfbasis",0,(void*)nfbasis,10,"GD&","nfbasis(T,{&dK}): integral basis of the field Q[a], where a is a root of the polynomial T, using the round 4 algorithm. An argument [T,listP] is possible, where listP is a list of primes or a prime bound, to get an order which is maximal at certain primes only. If present, dK is set to the discriminant of the returned order."},
...
{"nfdiscfactors",0,(void*)nfdiscfactors,10,"G","nfdiscfactors(T): [D, faD], where D = nfdisc(T), and faD is the factorization of |D|."},
...
{"nfeltispower",0,(void*)nfispower,10,"lGGLD&","nfeltispower(nf,x,n,{&y}): returns 1 if x is an n-th power in nf (and set y to an n-th root if present), else returns 0."},
{"nfeltissquare",0,(void*)nfissquare,10,"lGGD&","nfeltissquare(nf,x,{&y}): returns 1 if x is a square in nf (and sets y to a square root if present), else returns 0."},
...
{"nfhilbert",0,(void*)nfhilbert0,10,"lGGGDG","nfhilbert(nf,a,b,{pr}): if pr is omitted, global Hilbert symbol (a,b) in nf, that is 1 if X^2-aY^2-bZ^2 has a nontrivial solution (X,Y,Z) in nf, -1 otherwise. Otherwise compute the local symbol modulo the prime ideal pr."},
{"nfhnf",0,(void*)nfhnf0,10,"GGD0,L,","nfhnf(nf,x,{flag=0}): if x=[A,I], gives a pseudo-basis [B,J] of the module sum A_jI_j. If flag is nonzero, return [[B,J], U], where U is the transformation matrix such that AU = [0|B]."},
...
{"nfsubfieldscm",0,(void*)nfsubfieldscm,10,"GD0,L,","nfsubfieldscm(nf,{flag=0}): computes the maximal CM subfield of nf. Returns 0 if nf does not have a CM subfield, otherwise returns [g,h] (default) or g (flag=1) where g is an absolute equation and h expresses a root of g in terms of the generator of nf."},
{"nfsubfieldsmax",0,(void*)nfsubfieldsmax,10,"GD0,L,","nfsubfieldsmax(nf,{flag=0}): computes the list of maximal subfields of nf. The result is as in nfsubfields."},
{"nfweilheight",0,(void*)nfweilheight,10,"GGp","nfweilheight(nf, v): return the absolute Weil height of the vector v seen as an element of the projective space over the number field nf given by nfinit."},
...
{"parfor",0,(void*)parfor0,1,"vV=GDGJDVDI","parfor(i=a,{b},expr1,{r},{expr2}): evaluates the expression expr1 in parallel for all i between a and b (if b is set to +oo, the loop will not stop), resulting in as many values; if r and expr2 are present, the expression expr2 in the formal variables r and i is evaluated with r running through all the different results obtained for expr1 and i takes the corresponding argument."},
{"parforeach",0,(void*)parforeach0,1,"vGVJDVDI","parforeach(V,x,expr1,{r},{expr2}): evaluates in parallel the expression expr1 for all components x of V. If the formal variables r and expr2 are present, evaluate sequentially expr2, in which x and r are replaced by the successive arguments and corresponding values."},
...
{"parforstep",0,(void*)parforstep0,1,"vV=GDGGJDVDI","parforstep(i=a,{b},s,expr1,{r},{expr2}): evaluates the expression expr1 in parallel for i going from a to b in steps of s (can be a positive real number, an intmod for an arithmetic progression, or finally a vector of steps). If the formal variables r and expr2 are present, evaluates sequentially expr2, in which r has been replaced by the different results obtained for expr1 and i with the corresponding arguments."},
...
{"parsum",0,(void*)parsum,1,"V=GGJ","parsum(i=a,b,expr): the sum (i goes from a to b) of expression expr, evaluated in parallel (in random order)."},
...
{"permcycles",0,(void*)permcycles,4,"G","permcycles(x): cycles of the permutation x."},
{"permorder",0,(void*)permorder,4,"G","permorder(x): order of the permutation x."},
{"permsign",0,(void*)permsign,4,"lG","permsign(x): signature of the permutation x."},
{"permtonum",0,(void*)permtonum,4,"G","permtonum(x): ordinal (between 0 and n!-1) of permutation x."},
{"plot",0,(void*)pariplot0,17,"vV=GGEDGDGp","plot(X=a,b,expr,{Ymin},{Ymax}): crude plot of expression expr, X goes from a to b, with Y ranging from Ymin to Ymax. If Ymin (resp. Ymax) is not given, the minimum (resp. the maximum) of the expression is used instead."},
{"plotarc",0,(void*)plotarc,17,"vLGGD0,L,","plotarc(w,x2,y2,{filled=0}): if the cursor is at position (x1,y1), draws the ellipse that fits inside the box with diagonal (x1,y1) and (x2,y2) in rectwindow w (cursor does not move). If filled=1, fill the ellipse"},
{"plotbox",0,(void*)plotbox,17,"vLGGD0,L,","plotbox(w,x2,y2,{filled=0}): if the cursor is at position (x1,y1), draw a box with diagonal (x1,y1) and (x2,y2) in rectwindow w (cursor does not move). If filled=1, fill the box."},
{"plotclip",0,(void*)plotclip,17,"vL","plotclip(w): clip the contents of the rectwindow to the bounding box (except strings)."},
{"plotcolor",0,(void*)plotcolor,17,"LG","plotcolor(w,c): in rectwindow w, set default color to c. Possible values for c are [R,G,B] values, a color name or an index in the graphcolormap default: factory settings are 0=white, 1=black, 2=blue, 3=sienna, 4=red, 5=green, 6=grey, 7=gainsborough. Return [R,G,B] value attached to color."},
{"plotcopy",0,(void*)plotcopy,17,"vLLGGD0,L,","plotcopy(sourcew,destw,dx,dy,{flag=0}): copy the contents of rectwindow sourcew to rectwindow destw with offset (dx,dy). If flag's bit 1 is set, dx and dy express fractions of the size of the current output device, otherwise dx and dy are in pixels. dx and dy are relative positions of northwest corners if other bits of flag vanish, otherwise of: 2: southwest, 4: southeast, 6: northeast corners."},
{"plotcursor",0,(void*)plotcursor,17,"L","plotcursor(w): current position of cursor in rectwindow w."},
{"plotdraw",0,(void*)plotdraw,17,"vGD0,L,","plotdraw(w,{flag=0}): draw rectwindow w. More generally, w can be of the form [w1,x1,y1, w2,x2,y2,etc.]: draw rectwindows wi at given xi,yi positions. If flag!=0, the xi,yi express fractions of the size of the current output device."},
{"plotexport",0,(void*)plotexport,17,"GGD0,L,","plotexport(fmt,list,{flag=0}): draw vector of rectwindows list as in plotdraw, returning the resulting picture as a character string; fmt is either \"ps\" or \"svg\"."},
{"ploth",0,(void*)ploth0,17,"V=GGED0,M,D0,L,p\nParametric|1; Recursive|2; no_Rescale|4; no_X_axis|8; no_Y_axis|16; no_Frame|32; no_Lines|64; Points_too|128; Splines|256; no_X_ticks|512; no_Y_ticks|1024; Same_ticks|2048; Complex|4096; No_MinMax|8192;","ploth(X=a,b,expr,{flag=0},{n=0}): plot of expression expr, X goes from a to b in high resolution. Both flag and n are optional. Binary digits of flag mean: 1=Parametric, 2=Recursive, 4=no_Rescale, 8=no_X_axis, 16=no_Y_axis, 32=no_Frame, 64=no_Lines (do not join points), 128=Points_too (plot both lines and points), 256=Splines (use cubic splines), 512=no_X_ticks, 1024= no_Y_ticks, 2048=Same_ticks (plot all ticks with the same length), 4096=Complex (the two coordinates of each point are encoded as a complex number). n specifies number of reference points on the graph (0=use default value). Returns a vector for the bounding box."},
{"plothexport",0,(void*)plothexport0,17,"GV=GGED0,M,D0,L,p\nParametric|1; Recursive|2; no_Rescale|4; no_X_axis|8; no_Y_axis|16; no_Frame|32; no_Lines|64; Points_too|128; Splines|256; no_X_ticks|512; no_Y_ticks|1024; Same_ticks|2048; Complex|4096","plothexport(fmt,X=a,b,expr,{flags=0},{n=0}): plot of expression expr, X goes from a to b in high resolution, returning the resulting picture as a character string which can then be written to a file."},
{"plothraw",0,(void*)plothraw,17,"GGD0,L,","plothraw(X,Y,{flag=0}): plot in high resolution points whose x (resp. y) coordinates are in X (resp. Y). If flag is 1, join points, other nonzero flags should be combinations of bits 8,16,32,64,128,256 meaning the same as for ploth()."},
{"plothrawexport",0,(void*)plothrawexport,17,"GGGD0,L,","plothrawexport(fmt,X,Y,{flag=0}): plot in high resolution points whose x (resp. y) coordinates are in X (resp. Y), returning the resulting picture as a character string. If flag is 1, join points, other nonzero flags should be combinations of bits 8,16,32,64,128,256 meaning the same as for ploth()."},
{"plothsizes",0,(void*)plothsizes,17,"D0,L,","plothsizes({flag=0}): returns array of 8 elements: terminal width and height, sizes for ticks in horizontal and vertical directions, width and height of characters, width and height of display (if applicable). If flag=0, sizes of ticks and characters are in pixels, otherwise are fractions of the terminal size."},
{"plotinit",0,(void*)plotinit,17,"vLDGDGD0,L,","plotinit(w,{x},{y},{flag=0}): initialize rectwindow w to size x,y. If flag!=0, x and y express fractions of the size of the current output device. Omitting x or y means use the full size of the device."},
{"plotkill",0,(void*)plotkill,17,"vL","plotkill(w): erase the rectwindow w."},
{"plotlines",0,(void*)plotlines,17,"vLGGD0,L,","plotlines(w,X,Y,{flag=0}): draws an open polygon in rectwindow w where X and Y contain the x (resp. y) coordinates of the vertices. If X and Y are both single values (i.e not vectors), draw the corresponding line (and move cursor). If (optional) flag is nonzero, close the polygon."},
{"plotlinetype",0,(void*)plotlinetype,17,"vLL","plotlinetype(w,type): this function is obsolete; no graphing engine implement this functionality."},
{"plotmove",0,(void*)plotmove,17,"vLGG","plotmove(w,x,y): move cursor to position x,y in rectwindow w."},
{"plotpoints",0,(void*)plotpoints,17,"vLGG","plotpoints(w,X,Y): draws in rectwindow w the points whose x (resp y) coordinates are in X (resp Y). If X and Y are both single values (i.e not vectors), draw the corresponding point (and move cursor)."},
{"plotpointsize",0,(void*)plotpointsize,17,"vLG","plotpointsize(w,size): change the \"size\" of following points in rectwindow w. w=-1 changes global value."},
{"plotpointtype",0,(void*)plotpointtype,17,"vLL","plotpointtype(w,type): this function is obsolete; no graphing engine implement this functionality."},
{"plotrbox",0,(void*)plotrbox,17,"vLGGD0,L,","plotrbox(w,dx,dy,{filled}): if the cursor is at (x1,y1), draw a box with diagonal (x1,y1)-(x1+dx,y1+dy) in rectwindow w (cursor does not move). If filled=1, fill the box."},
{"plotrecth",0,(void*)plotrecth0,17,"LV=GGED0,M,D0,L,p\nParametric|1; Recursive|2; no_Rescale|4; no_X_axis|8; no_Y_axis|16; no_Frame|32; no_Lines|64; Points_too|128; Splines|256; no_X_ticks|512; no_Y_ticks|1024; Same_ticks|2048; Complex|4096","plotrecth(w,X=a,b,expr,{flag=0},{n=0}): writes to rectwindow w the curve output of ploth(w,X=a,b,expr,flag,n). Returns a vector for the bounding box."},
{"plotrecthraw",0,(void*)plotrecthraw,17,"LGD0,L,","plotrecthraw(w,data,{flags=0}): plot graph(s) for data in rectwindow w, where data is a vector of vectors. If plot is parametric, length of data should be even, and pairs of entries give curves to plot. If not, first entry gives x-coordinate, and the other ones y-coordinates. Admits the same optional flags as plotrecth, save that recursive plot is meaningless."},
{"plotrline",0,(void*)plotrline,17,"vLGG","plotrline(w,dx,dy): if the cursor is at (x1,y1), draw a line from (x1,y1) to (x1+dx,y1+dy) (and move the cursor) in the rectwindow w."},
{"plotrmove",0,(void*)plotrmove,17,"vLGG","plotrmove(w,dx,dy): move cursor to position (dx,dy) relative to the present position in the rectwindow w."},
{"plotrpoint",0,(void*)plotrpoint,17,"vLGG","plotrpoint(w,dx,dy): draw a point (and move cursor) at position dx,dy relative to present position of the cursor in rectwindow w."},
{"plotscale",0,(void*)plotscale,17,"vLGGGG","plotscale(w,x1,x2,y1,y2): scale the coordinates in rectwindow w so that x goes from x1 to x2 and y from y1 to y2 (y2<y1 is allowed)."},
{"plotstring",0,(void*)plotstring,17,"vLsD0,L,","plotstring(w,x,{flags=0}): draw in rectwindow w the string corresponding to x. Bits 1 and 2 of flag regulate horizontal alignment: left if 0, right if 2, center if 1. Bits 4 and 8 regulate vertical alignment: bottom if 0, top if 8, v-center if 4. Can insert additional gap between point and string: horizontal if bit 16 is set, vertical if bit 32 is set."},
{"polchebyshev",0,(void*)polchebyshev_eval,6,"LD1,L,DG","polchebyshev(n,{flag=1},{a='x}): Chebyshev polynomial of the first (flag = 1) or second (flag = 2) kind, of degree n, evaluated at a."},
...
{"polcoeff",0,(void*)polcoef,6,"GLDn","polcoeff(x,n,{v}): deprecated alias for polcoef."},
...
{"poldegree",0,(void*)gppoldegree,6,"GDn","poldegree(x,{v}): degree of the polynomial or rational function x with respect to main variable if v is omitted, with respect to v otherwise. For scalar x, return 0 if x is nonzero and -oo otherwise."},
...
{"polfromroots",0,(void*)polfromroots,6,"GDn","polfromroots(a,{v=x}): returns the monic polynomial in variable v whose roots are the components of the vector a with multiplicities."},
...
{"polhermite",0,(void*)polhermite_eval0,6,"LDGD0,L,","polhermite(n,{a='x},{flag=0}): Hermite polynomial H(n,v) of degree n, evaluated at a. If flag is nonzero, return [H_{n-1}(a), H_n(a)]."},
{"polinterpolate",0,(void*)polint,6,"GDGDGD&","polinterpolate(X,{Y},{t = 'x},{&e}): polynomial interpolation at t according to data vectors X, Y, i.e., given P of minimal degree such that P(X[i]) = Y[i] for all i, return P(t). If Y is omitted, take P such that P(i) = X[i]. If present and t is numeric, e will contain an error estimate on the returned value (Neville's algorithm)."},
{"polisclass",0,(void*)polisclass,6,"lG","polisclass(P): P being a monic irreducible polynomial with integer coefficients, return 0 if P is not a class polynomial for the j-invariant, otherwise return the discriminant D<0 such that P=polclass(D)."},
...
{"polisirreducible",0,(void*)polisirreducible,6,"lG","polisirreducible(pol): true(1) if pol is an irreducible nonconstant polynomial, false(0) if pol is reducible or constant."},
{"pollaguerre",0,(void*)pollaguerre_eval0,6,"LDGDGD0,L,","pollaguerre(n,{a=0},{b='x},{flag=0}): Laguerre polynomial of degree n and parameter a evaluated at b. If flag is 1, return [L^{(a)_{n-1}(b), L^{(a)}_n(b)]."},
...
{"pollegendre",0,(void*)pollegendre_eval0,6,"LDGD0,L,","pollegendre(n,{a='x},{flag=0}): legendre polynomial of degree n evaluated at a. If flag is 1, return [P_{n-1}(a), P_n(a)]."},
...
{"polrootspadic",0,(void*)polrootspadic,6,"GGL","polrootspadic(f,p,r): p-adic roots of the polynomial f to precision r."},
...
{"polteichmuller",0,(void*)polteichmuller,6,"GUL","polteichmuller(T,p,r): return the polynomial whose roots (resp. leading coef) are the Teichmuller lift of the roots (resp. leading coef) of T, to p-adic precision r."},
{"poltomonic",0,(void*)poltomonic,6,"GD&","poltomonic(T,{&L}): T in Q[x]; returns U monic in Z[x] such that U(x) = C T(x/L) for some rational C and L. If &L is given, set it to L."},
...
{"polylogmult",0,(void*)polylogmult_interpolate,8,"GDGDGp","polylogmult(s,{z},{t=0}): multiple polylogarithm value at integral s = [s1,...,sr] with argument z = [z1,...,zr]. If z is omitted, assume z = [1,...,1], i.e., multiple zeta value. More generally, return Yamamoto's interpolation at t (ordinary multiple polylog at t = 0 and star value at t = 1)."},
{"polzagier",0,(void*)polzag,6,"LL","polzagier(n,m): Zagier's polynomials of index n,m."},
{"powers",0,(void*)gpowers0,7,"GLDG","powers(x,n,{x0}): return the vector [1,x,...,x^n] if x0 is omitted, and [x0, x0*x, ..., x0*x^n] otherwise."},
{"precision",0,(void*)precision00,3,"GDG","precision(x,{n}): if n is present, return x at precision n. If n is omitted, return real precision of object x."},
...
{"primecert",0,(void*)primecert0,5,"GD0,L,D0,L,","primecert(N,{flag=0},{partial=0}): If N is a prime, return a Primality Certificate.  Return 0 otherwise. If flag = 0 return an ECPP certificate (Atkin-Morain); if flag = 1 return an N-1 certificate (Pocklington-Lehmer)"},
...
{"prodeuler",0,(void*)prodeuler0,9,"V=GGEp","prodeuler(p=a,b,expr): Euler product (p runs over the primes between a and b) of real or complex expression, as a floating point approximation."},
...
{"psdraw",0,(void*)psdraw,17,"vGD0,L,","psdraw(list,{flag=0}): obsolete function."},
{"psi",0,(void*)gpsi_der,8,"GD0,L,p","psi(x,{der}): psi-function at x (der-th derivative of psi if der is set)"},
{"psploth",0,(void*)psploth0,17,"V=GGED0,M,D0,L,p\nParametric|1; Recursive|2; no_Rescale|4; no_X_axis|8; no_Y_axis|16; no_Frame|32; no_Lines|64; Points_too|128; Splines|256; no_X_ticks|512; no_Y_ticks|1024; Same_ticks|2048; Complex|4096","psploth(X=a,b,expr,{flags=0},{n=0}): obsolete function."},
{"psplothraw",0,(void*)psplothraw,17,"GGD0,L,","psplothraw(listx,listy,{flag=0}): obsolete function."},
...
{"qfbcomp",0,(void*)qfbcomp,5,"GG","qfbcomp(x,y): Gaussian composition with reduction of the binary quadratic forms x and y."},
...
{"qfbcornacchia",0,(void*)qfbcornacchia,5,"GG","qfbcornacchia(d,n): Solves the equation x^2+dy^2 = n in integers x and y where d > 0 and n is prime or 4 times a prime."},
...
{"qfbpow",0,(void*)qfbpow,5,"GG","qfbpow(x,n): n-th power with reduction of the binary quadratic form x."},
{"qfbpowraw",0,(void*)qfbpowraw,5,"GL","qfbpowraw(x,n): n-th power without reduction of the binary quadratic form x."},
{"qfbprimeform",0,(void*)primeform,5,"GG","qfbprimeform(x,p): returns the prime form of discriminant x, whose first coefficient is p."},
...
{"qfbredsl2",0,(void*)qfbredsl2,5,"GDG","qfbredsl2(x,{isD}): reduction of the binary quadratic form x, returns [y,g] where y is reduced and g in Sl(2,Z) is such that g.x = y; isD, if present, must be equal to sqrtint(D), where D > 0 is the discriminant of x."},
...
{"qfcholesky",0,(void*)qfcholesky,7,"Gp","qfcholesky(q): given a square symmetric matrix M, return R such that R~*R = M, or [] if there is no solution."},
{"qfcvp",0,(void*)qfcvp0,7,"GGDGDGD0,L,","qfcvp(x,t,{B},{m},{flag=0}): x being a square and symmetric matrix representing a positive definite quadratic form, and t a vector of the same dimension, this function deals with the vectors of whose squared distance to t is less than B, enumerated using the Fincke-Pohst algorithm, storing at most m vectors (no limit if m is omitted). The function searches for the closest vectors to t if B is omitted or <= 0. The precise behavior depends on flag. 0: returns at most m vectors (unless m omitted), returns [N,M,V] where N is the number of vectors enumerated, M the maximum squared distance among these, and V lists the vectors. 1: ignores m and returns the first vector whose squared distance to t is less than B."},
...
{"qfgaussred",0,(void*)qfgaussred0,7,"GD0,L,","qfgaussred(q,{flag=0}): square reduction of the symmetric matrix q. flag=0: returns a square matrix A such that q(x) = sum_i A[i,i] (x[i] + sum_{j != i} A[i,j] x[j])^2; flag=1 return [U,V] where U is a square matrix and V a vector such that q = U~ * matdiagonal(V) * U"},
...
{"qfminimize",0,(void*)qfminimize,7,"G","qfminimize(G): given a square symmetric matrix G with rational  coefficients and non-zero determinant, of dimension n >= 1, return [H,U,c] such that H = c * U~*G*U for some rational c, and H integral with minimal determinant."},
...
{"qfperfection",0,(void*)qfperfection,7,"G","qfperfection(G): rank of matrix of xx~ for x minimal vectors of a Gram matrix G."},
...
{"qfsolve",0,(void*)qfsolve,7,"G","qfsolve(G): solve over Q the quadratic equation X~ G X = 0, where G is a symmetric matrix."},
...
{"quadregulator",0,(void*)quadregulator,5,"Gp","quadregulator(D): regulator of the real quadratic field of discriminant D."},
{"quadunit",0,(void*)quadunit0,5,"GDn","quadunit(D,{v = 'w}): fundamental unit u of the quadratic order of discriminant D where D must be positive. If v is given, the variable name is used to display u, else 'w' is used."},
{"quadunitindex",0,(void*)quadunitindex,5,"GG","quadunitindex(D,f): given a fundamental discriminant D, returns the index of the unit group of the order of conductor f."},
{"quadunitnorm",0,(void*)quadunitnorm,5,"lG","quadunitnorm(D): returns the norm of the fundamental unit of the quadratic order of discriminant D."},
{"ramanujantau",0,(void*)ramanujantau,5,"GD12,L,","ramanujantau(n,{ell=12}): compute the value of Ramanujan's tau function at n, assuming the GRH. If ell is 16, 18, 20, 22, or 26, same for the newform of level 1 and corresponding weight. Otherwise, compute the coefficient of the trace form at n. Algorithm in O(n^{1/2+eps})."},
...
{"randomprime",0,(void*)randomprime0,5,"DGDG","randomprime({N=2^31},{q}): returns a strong pseudo prime in [2, N-1]. If q is an integer, return a prime = 1 mod q; if q is an intmod, return a prime in the given congruence class."},
...
{"rnfisfree",0,(void*)rnfisfree,10,"lGG","rnfisfree(bnf,M): given a bnf attached to a number field K and a projective Z_K module M given by a pseudo-matrix, return true (1) if M is free else return false (0)."},
...
{"rnfisnorm",0,(void*)rnfisnorm,10,"GGD0,L,","rnfisnorm(T,a,{flag=0}): T is as output by rnfisnorminit applied to L/K. Tries to tell whether a is a norm from L/K. Returns a vector [x,q] where a=Norm(x)*q. Looks for a solution which is a S-integer, with S a list of places in K containing the ramified primes, generators of the class group of ext, as well as those primes dividing a. If L/K is Galois, you may omit flag, otherwise it is used to add more places to S: all the places above the primes p <= flag (resp. p | flag) if flag > 0 (resp. flag < 0). The answer is guaranteed (i.e a is a norm iff q=1) if L/K is Galois or, under GRH, if S contains all primes less than 4log(disc(M))^2, where M is the normal closure of L/K."},
...
{"rnfkummer",0,(void*)rnfkummer,10,"GDGp","rnfkummer(bnr,{subgp}): this function is deprecated. Use bnrclassfield."},
...
{"seralgdep",0,(void*)seralgdep,6,"GLL","seralgdep(s,p,r): find a linear relation between powers (1,s, ..., s^p) of the series s, with polynomial coefficients of degree <= r."},
...
{"serdiffdep",0,(void*)serdiffdep,6,"GLL","serdiffdep(s,p,r): find an inhomogenous linear differential equation satisfied by the series s, with polynomial coefficients of degree <= r. The result is a pair [E,P] such that E(d)(S)=P where E(d) is interpreted as a differential polynomial, or 0 in case no relation is found."},
...
{"setdebug",0,(void*)setdebug,1,"DsD-1,L,","setdebug({D},{n}): sets debug level for domain D to n (n must be between 0 and 20). If n is omitted, returns the current level for domain D. if D is omitted, returns a two-column matrix which lists the available domains with their levels."},
{"setdelta",0,(void*)setdelta,7,"GG","setdelta(x,y): symmetric difference of the sets x and y."},
...
{"snfrank",0,(void*)snfrank,7,"lGDG","snfrank(D,{q=0}): assuming that D is a Smith normal form (i.e. vector of elementary divisors) for some module and q a power of an irreducible element or 0 (default if omitted), returns the rank of D/qD."},
{"solve",0,(void*)zbrent0,9,"V=GGEp","solve(X=a,b,expr): real root of expression expr (X between a and b), where either a or b is infinite or expr(a)*expr(b)<=0."},
...
{"sqrtint",0,(void*)sqrtint0,5,"GD&","sqrtint(x,{&r}): integer square root y of x, where x is a nonnegative real number. If r is present, set it to the remainder x - y^2."},
...
{"sqrtnint",0,(void*)sqrtnint,5,"GL","sqrtnint(x,n): integer n-th root of x, where x is nonnegative real number."},
...
{"strchr",0,(void*)pari_strchr,1,"G","strchr(x): converts integer or vector of integers x to a string, translating each integer into a character using ASCII encoding."},
{"strexpand",0,(void*)strexpand,1,"s*","strexpand({x}*): concatenates its (string) arguments into a single string, performing tilde expansion."},
{"strjoin",0,(void*)strjoin,1,"GDG","strjoin(v,{p = \"\"}): joins the strings in vector v, separating them with delimiter p."},
...
{"strsplit",0,(void*)strsplit,1,"GDG","strsplit(s,{p = \"\"}): splits the string s into a vector of strings, with p acting as a delimiter between successive fields; if p is empty or omitted, split into characters."},
{"strtex",0,(void*)strtex,1,"s*","strtex({x}*): translates its (string) arguments to TeX format and returns the resulting string."},
{"strtime",0,(void*)strtime,1,"L","strtime(t): return a string describing the time t in milliseconds, in the format used by the GP timer."},
{"subcyclohminus",0,(void*)subcyclohminus,10,"GDG","subcyclohminus(fH,{p=0}): Let F be the abelian number field contained in Q(zeta_f) corresponding to the subgroup H of (Z/fZ)^*. Let h be the relative class number h^-(F) and Q the Hasse unit index in {1,2}. If Q could be computed, returns [h, Q]; else returns [2h/Q, 0]."},
{"subcycloiwasawa",0,(void*)subcycloiwasawa,10,"GGD0,L,","subcycloiwasawa(fH,p,{n=0}): Let F be the abelian number field contained in Q(zeta_f) corresponding to the subgroup H of (Z/fZ)^*. Returns the minus part of Iwasawa polynomials attached to the cyclotomic Z_p extension of F."},
{"subcyclopclgp",0,(void*)subcyclopclgp,10,"GGD0,L,","subcyclopclgp(fH,p,{flag=0}): Let F be the abelian number field contained in Q(zeta_f) corresponding to the subgroup H of (Z/fZ)^*. Returns the minus part of Iwasawa polynomials attached to the ideal class group of F."},
{"subgrouplist",0,(void*)subgrouplist0,10,"GDGD0,L,","subgrouplist(cyc,{bound},{flag=0}): cyc being any object which has a '.cyc' method giving the cyclic components for a finite Abelian group G, outputs the list of subgroups of G (of index bounded by bound, if not omitted), given as HNF left divisors of the SNF matrix corresponding to G. If flag=0 (default) and 'cyc' is a bnr struture output by bnrinit, gives only the subgroups whose conductor is the modulus bnr.mod"},
...
{"sumdivmult",0,(void*)sumdivmultexpr0,9,"GVE","sumdivmult(n,d,expr): sum of multiplicative function expr, d running over the divisors of n."},
...
{"suminf",0,(void*)suminf0,9,"V=GEb","suminf(X=a,expr): naive summation (X goes from a to infinity) of real or complex expression expr."},
...
{"sumnumsidi",0,(void*)sumnumsidi0,9,"V=GED1,L,p","sumnumsidi(n=a,f,{safe=1}): numerical summation of f(n) from n = a to +infinity using Sidi summation; a must be an integer. If safe is set to 0, the function is faster but much less robust."},
...
{"system",0,(void*)gpsystem,1,"ls","system(str): str being a string, execute the system command str."},
...
{"thueinit",0,(void*)thueinit,6,"GD0,L,p","thueinit(P,{flag=0}): initialize the tnf corresponding to P, that will be used to solve Thue equations P(x,y) = some-integer. If flag is nonzero, certify the result unconditionally. Otherwise, assume GRH (much faster of course)."},
...
{"unexport",0,NULL,1,NULL,"unexport(x,...,z): remove x,...,z from the list of variables exported to the parallel world."},
{"unexportall",0,(void*)unexportall,1,"v","unexportall(): empty the list of variables exported to the parallel world."},
{"uninline",0,NULL,1,NULL,"uninline(): forget all inline variables. DEPRECATED, use export."},
{"until",0,(void*)untilpari,1,"vEI","until(a,seq): evaluate the expression sequence seq until a is nonzero."},
{"valuation",0,(void*)gpvaluation,3,"GDG","valuation(x,{p}): valuation of x with respect to p."},
...
{"variables",0,(void*)variables_vec,3,"DG","variables({x}): all variables occurring in object x, sorted by decreasing priority. Returns the list of user variables if x is omitted."},
...
{"vecsort",0,(void*)vecsort0,7,"GDGD0,L,","vecsort(x,{cmpf},{flag=0}): sorts the vector x in ascending order, according to the comparison function cmpf, if not omitted. Binary digits of flag (if present) mean: 1: indirect sorting, return the permutation instead of the permuted vector, 4: use descending instead of ascending order, 8: remove duplicate entries."},
{"vecsum",0,(void*)vecsum,7,"G","vecsum(v): return the sum of the components of the vector v."},
{"vector",0,(void*)vecteur,7,"GDVDE","vector(n,{X},{expr=0}): row vector with n components of expression expr (X ranges from 1 to n). By default, fills with 0s."},
{"vectorsmall",0,(void*)vecteursmall,7,"GDVDE","vectorsmall(n,{X},{expr=0}): VECSMALL with n components of expression expr (X ranges from 1 to n) which must be small integers. By default, fills with 0s."},
...
{"version",0,(void*)pari_version,1,"","version(): returns the PARI version as [major,minor,patch] or [major,minor,patch,GITversion]."},
{"warning",0,(void*)warning0,1,"vs*","warning({str}*): display warning message str."},
{"weber",0,(void*)weber0,8,"GD0,L,p","weber(x,{flag=0}): one of Weber's f function of x. flag is optional, and can be 0: default, function f(x)=exp(-i*Pi/24)*eta((x+1)/2)/eta(x), 1: function f1(x)=eta(x/2)/eta(x) 2: function f2(x)=sqrt(2)*eta(2*x)/eta(x)."},
...
{"zetamult",0,(void*)zetamult_interpolate,8,"GDGp","zetamult(s,{t=0}): multiple zeta value at integral s = [s1,...,sk]; more generally, return Yamamoto's t-MZV interpolation (star value for t = 1)."},
...
{"zetamultconvert",0,(void*)zetamultconvert,8,"GD1,L,","zetamultconvert(a,{flag=1}): a being either an evec, avec, or index m, converts into evec (flag=0), avec (flag=1), or index m (flag=2)."},
{"zetamultdual",0,(void*)zetamultdual,8,"G","zetamultdual(s): s being either an evec, avec, or index m, return the dual sequence in avec format."},
...
{"znchartoprimitive",0,(void*)znchartoprimitive,5,"GG","znchartoprimitive(G,chi): let G be znstar(q,1) and chi be a Dirichlet character on (Z/qZ)* of conductor q0. Return [G0,chi0], where chi0 is the primitive character attached to chi and G0 is znstar(q0,1)."},
...
{"zncoppersmith",0,(void*)zncoppersmith,5,"GGGDG","zncoppersmith(P,N,X,{B=N}): finds all integers x with |x| <= X such that  gcd(N, P(x)) >= B. The parameter X should be smaller than exp((log B)^2 / (deg(P) log N)) and the leading coefficient of P should be coprime to N."},
...
{"znsubgroupgenerators",0,(void*)znsubgroupgenerators,5,"GD0,L,","znsubgroupgenerators(H,{flag=0}): finds generators of the subgroup H of (Z/fZ)^*; H is given by a vector of length f of 1/0 values: the a-th component is 1 if and only if a belongs to H."},
